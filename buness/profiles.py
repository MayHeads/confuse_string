...
PROFILES = {
    ...
    "tt_rate_tracker": BunessProfile(
        ...
        description="Rate Tracker SDK 全流程，包含配置覆盖、Pod 替换、字符串和文件处理、垃圾代码、pod install。",
        overrides={
    ...
    "tt_route_sdk": BunessProfile(
        ...
        overrides={
            "NEW_POD_FILE_NAME": "DailyCameraMainSDK",
            "THEME_KEYWORDS": ["相机", "位置", "参数", "位置", "滤镜"],
            "NUM_FILES":    34,
    ...
    "tt_route_sdk_flutter": BunessProfile(
        ...
        overrides={
            "NEW_POD_FILE_NAME": "PetHealthBaseSDK",
            "THEME_KEYWORDS": ["宠物", "方向", "配置", "临时", "结果", "进度"],
            "NUM_FILES":   44,
            "project_path": "/Users/may/ttfluttersdk",
            "ROOT_PROJECT_DIR": "/Users/may/ttfluttersdk",
    ...
    "tt_route_sdk_flutter_overseas": BunessProfile(
    name="tt_route_sdk_flutter",
    description="Flutter Route SDK 流程，含 Dart/Plugin 重命名、README 映射同步、字符串加密、垃圾代码、Pod 和 clean.py。",
    overrides={
        "NEW_POD_FILE_NAME": "PkksBaseSDK",
        "THEME_KEYWORDS": ["植物", "详图", "参数", "位置", "结果", "进度"],
        "NUM_FILES":  33,
