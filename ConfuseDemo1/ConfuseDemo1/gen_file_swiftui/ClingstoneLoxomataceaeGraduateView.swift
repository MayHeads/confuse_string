...
struct ClingstoneLoxomataceaeGraduateView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ClingstoneLoxomataceaeGraduate")
    }
...
// Preview provider
struct ClingstoneLoxomataceaeGraduateView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ClingstoneLoxomataceaeGraduateView()
        }
    }
}
