...
struct VividnessOutrageousnessManeaterView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("VividnessOutrageousnessManeater")
    }
...
// Preview provider
struct VividnessOutrageousnessManeaterView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            VividnessOutrageousnessManeaterView()
        }
    }
}
