...
struct TiliacordataLitmustestSleddingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TiliacordataLitmustestSledding")
    }
...
// Preview provider
struct TiliacordataLitmustestSleddingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TiliacordataLitmustestSleddingView()
        }
    }
}
