...
struct EuskaditaaskatasunaGymnocladusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EuskaditaaskatasunaGymnocladus")
    }
...
// Preview provider
struct EuskaditaaskatasunaGymnocladusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EuskaditaaskatasunaGymnocladusView()
        }
    }
}
