...
struct NitrogenaseOrnithogalumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NitrogenaseOrnithogalum")
    }
...
// Preview provider
struct NitrogenaseOrnithogalumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NitrogenaseOrnithogalumView()
        }
    }
}
