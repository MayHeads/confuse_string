...
struct GreatanteaterTaskmasterPaystationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GreatanteaterTaskmasterPaystation")
    }
...
// Preview provider
struct GreatanteaterTaskmasterPaystationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GreatanteaterTaskmasterPaystationView()
        }
    }
}
