...
struct CanvassAlignmentHaussaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CanvassAlignmentHaussa")
    }
...
// Preview provider
struct CanvassAlignmentHaussaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CanvassAlignmentHaussaView()
        }
    }
}
