...
struct AlanstewartpatonMonComparingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AlanstewartpatonMonComparing")
    }
...
// Preview provider
struct AlanstewartpatonMonComparingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AlanstewartpatonMonComparingView()
        }
    }
}
