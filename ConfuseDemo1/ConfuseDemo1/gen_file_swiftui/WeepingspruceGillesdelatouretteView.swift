...
struct WeepingspruceGillesdelatouretteView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WeepingspruceGillesdelatourette")
    }
...
// Preview provider
struct WeepingspruceGillesdelatouretteView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WeepingspruceGillesdelatouretteView()
        }
    }
}
