...
struct CocoanutSpokespersonView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CocoanutSpokesperson")
    }
...
// Preview provider
struct CocoanutSpokespersonView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CocoanutSpokespersonView()
        }
    }
}
