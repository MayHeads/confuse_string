...
struct EdwardsGardenpeaplantGenusdrynariaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EdwardsGardenpeaplantGenusdrynaria")
    }
...
// Preview provider
struct EdwardsGardenpeaplantGenusdrynariaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EdwardsGardenpeaplantGenusdrynariaView()
        }
    }
}
