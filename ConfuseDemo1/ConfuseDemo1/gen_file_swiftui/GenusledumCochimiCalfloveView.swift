...
struct GenusledumCochimiCalfloveView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GenusledumCochimiCalflove")
    }
...
// Preview provider
struct GenusledumCochimiCalfloveView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GenusledumCochimiCalfloveView()
        }
    }
}
