...
struct NigroporusSchoolyardView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NigroporusSchoolyard")
    }
...
// Preview provider
struct NigroporusSchoolyardView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NigroporusSchoolyardView()
        }
    }
}
