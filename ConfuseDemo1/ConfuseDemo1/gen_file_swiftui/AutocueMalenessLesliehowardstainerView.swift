...
struct AutocueMalenessLesliehowardstainerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AutocueMalenessLesliehowardstainer")
    }
...
// Preview provider
struct AutocueMalenessLesliehowardstainerView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AutocueMalenessLesliehowardstainerView()
        }
    }
}
