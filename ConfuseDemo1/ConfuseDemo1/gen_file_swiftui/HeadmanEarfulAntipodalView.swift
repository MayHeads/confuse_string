...
struct HeadmanEarfulAntipodalView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HeadmanEarfulAntipodal")
    }
...
// Preview provider
struct HeadmanEarfulAntipodalView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HeadmanEarfulAntipodalView()
        }
    }
}
