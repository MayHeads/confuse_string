...
struct IanfuSpotterWelshspringerspanielView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("IanfuSpotterWelshspringerspaniel")
    }
...
// Preview provider
struct IanfuSpotterWelshspringerspanielView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            IanfuSpotterWelshspringerspanielView()
        }
    }
}
