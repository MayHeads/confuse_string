...
struct GenuscestumClogSensitiveView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GenuscestumClogSensitive")
    }
...
// Preview provider
struct GenuscestumClogSensitiveView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GenuscestumClogSensitiveView()
        }
    }
}
