...
struct DeactivationCoffinnailHomaridaeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DeactivationCoffinnailHomaridae")
    }
...
// Preview provider
struct DeactivationCoffinnailHomaridaeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DeactivationCoffinnailHomaridaeView()
        }
    }
}
