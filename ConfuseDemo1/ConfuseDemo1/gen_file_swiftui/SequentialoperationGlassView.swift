...
struct SequentialoperationGlassView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SequentialoperationGlass")
    }
...
// Preview provider
struct SequentialoperationGlassView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SequentialoperationGlassView()
        }
    }
}
