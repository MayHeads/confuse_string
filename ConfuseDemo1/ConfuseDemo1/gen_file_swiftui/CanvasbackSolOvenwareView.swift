...
struct CanvasbackSolOvenwareView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CanvasbackSolOvenware")
    }
...
// Preview provider
struct CanvasbackSolOvenwareView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CanvasbackSolOvenwareView()
        }
    }
}
