...
struct BougainvillaeaRoadmanParkinsonismView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BougainvillaeaRoadmanParkinsonism")
    }
...
// Preview provider
struct BougainvillaeaRoadmanParkinsonismView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BougainvillaeaRoadmanParkinsonismView()
        }
    }
}
