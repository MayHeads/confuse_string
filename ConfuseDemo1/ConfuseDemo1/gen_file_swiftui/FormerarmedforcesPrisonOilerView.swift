...
struct FormerarmedforcesPrisonOilerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FormerarmedforcesPrisonOiler")
    }
...
// Preview provider
struct FormerarmedforcesPrisonOilerView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FormerarmedforcesPrisonOilerView()
        }
    }
}
