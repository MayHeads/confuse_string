...
struct ZantacPanellistGooleboyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ZantacPanellistGooleboy")
    }
...
// Preview provider
struct ZantacPanellistGooleboyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ZantacPanellistGooleboyView()
        }
    }
}
