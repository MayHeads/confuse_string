...
struct PeromyscusSongEuphoryView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PeromyscusSongEuphory")
    }
...
// Preview provider
struct PeromyscusSongEuphoryView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PeromyscusSongEuphoryView()
        }
    }
}
