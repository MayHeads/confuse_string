...
COMMON_QUALITY = 98                 # 输出图片质量 (1-100)

# 仿射变换工具配置
SCALE_X = 0.989                       # X轴缩放比例 (0.1-2.0, 小于1为瘦身，大于1为拉伸)  最好是0.9 - 0.99 不要进行参数太小
...
# 模糊工具配置
BLUR_RADIUS = 1.2                      # 模糊半径 (1-20, 数值越大越模糊)  1.5-3   5太大了
...
# 锐化工具配置
SHARPEN_STRENGTH = 185               # 锐化强度 (0.1-5.0)
SHARPEN_TYPE = 'unsharp_mask'        # 锐化类型 ('unsharp_mask', 'sharpen', 'detail', 'enhance')



# 轮廓增强工具配置
CONTOUR_STRENGTH = 2.8               # 轮廓增强强度 (0.1-5.0)
CONTOUR_TYPE = 'contour'             # 轮廓增强类型 ('edge_enhance', 'edge_enhance_more', 'find_edges', 'emboss', 'contour', 'enhance')
