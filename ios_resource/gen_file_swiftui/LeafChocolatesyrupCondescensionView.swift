...
struct LeafChocolatesyrupCondescensionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LeafChocolatesyrupCondescension")
    }
...
// Preview provider
struct LeafChocolatesyrupCondescensionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LeafChocolatesyrupCondescensionView()
        }
    }
}
