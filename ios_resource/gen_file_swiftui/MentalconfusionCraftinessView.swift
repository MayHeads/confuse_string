...
struct MentalconfusionCraftinessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MentalconfusionCraftiness")
    }
...
// Preview provider
struct MentalconfusionCraftinessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MentalconfusionCraftinessView()
        }
    }
}
