...
struct AlohaAshtrayEzoyamahagiView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AlohaAshtrayEzoyamahagi")
    }
...
// Preview provider
struct AlohaAshtrayEzoyamahagiView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AlohaAshtrayEzoyamahagiView()
        }
    }
}
