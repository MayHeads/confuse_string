...
struct HearingofficerBountifulnessNeargaleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HearingofficerBountifulnessNeargale")
    }
...
// Preview provider
struct HearingofficerBountifulnessNeargaleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HearingofficerBountifulnessNeargaleView()
        }
    }
}
