...
struct LipoidLeafformBursaryView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LipoidLeafformBursary")
    }
...
// Preview provider
struct LipoidLeafformBursaryView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LipoidLeafformBursaryView()
        }
    }
}
