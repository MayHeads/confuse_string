...
struct TravellerstreeNewtonsthirdlawView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TravellerstreeNewtonsthirdlaw")
    }
...
// Preview provider
struct TravellerstreeNewtonsthirdlawView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TravellerstreeNewtonsthirdlawView()
        }
    }
}
