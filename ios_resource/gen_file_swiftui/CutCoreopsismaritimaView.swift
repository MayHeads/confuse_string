...
struct CutCoreopsismaritimaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CutCoreopsismaritima")
    }
...
// Preview provider
struct CutCoreopsismaritimaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CutCoreopsismaritimaView()
        }
    }
}
