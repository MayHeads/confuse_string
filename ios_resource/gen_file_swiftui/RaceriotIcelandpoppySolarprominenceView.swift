...
struct RaceriotIcelandpoppySolarprominenceView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("RaceriotIcelandpoppySolarprominence")
    }
...
// Preview provider
struct RaceriotIcelandpoppySolarprominenceView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RaceriotIcelandpoppySolarprominenceView()
        }
    }
}
