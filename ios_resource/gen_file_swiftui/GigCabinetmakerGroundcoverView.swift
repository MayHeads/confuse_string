...
struct GigCabinetmakerGroundcoverView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GigCabinetmakerGroundcover")
    }
...
// Preview provider
struct GigCabinetmakerGroundcoverView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GigCabinetmakerGroundcoverView()
        }
    }
}
