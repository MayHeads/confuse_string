...
public struct PerceptionLollyTagalongView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("PerceptionLollyTagalong")
    }
...
// Preview provider
public struct PerceptionLollyTagalongView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            PerceptionLollyTagalongView()
        }
    }
}
