...
struct MulliganstewBallotboxMiffView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MulliganstewBallotboxMiff")
    }
...
// Preview provider
struct MulliganstewBallotboxMiffView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MulliganstewBallotboxMiffView()
        }
    }
}
