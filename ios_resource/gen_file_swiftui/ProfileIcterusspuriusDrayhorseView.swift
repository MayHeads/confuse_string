...
struct ProfileIcterusspuriusDrayhorseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ProfileIcterusspuriusDrayhorse")
    }
...
// Preview provider
struct ProfileIcterusspuriusDrayhorseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ProfileIcterusspuriusDrayhorseView()
        }
    }
}
