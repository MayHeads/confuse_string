...
struct StrokePolychaetewormLiothyronineView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("StrokePolychaetewormLiothyronine")
    }
...
// Preview provider
struct StrokePolychaetewormLiothyronineView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            StrokePolychaetewormLiothyronineView()
        }
    }
}
