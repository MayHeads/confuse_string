...
struct UbledutchGenusgenliseaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UbledutchGenusgenlisea")
    }
...
// Preview provider
struct UbledutchGenusgenliseaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UbledutchGenusgenliseaView()
        }
    }
}
