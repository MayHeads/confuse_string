...
public struct BimboChemisorptionGeorgewashingtonView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BimboChemisorptionGeorgewashington")
    }
...
// Preview provider
public struct BimboChemisorptionGeorgewashingtonView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BimboChemisorptionGeorgewashingtonView()
        }
    }
}
