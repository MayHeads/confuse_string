...
struct InmigrationSilenceHandyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("InmigrationSilenceHandy")
    }
...
// Preview provider
struct InmigrationSilenceHandyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            InmigrationSilenceHandyView()
        }
    }
}
