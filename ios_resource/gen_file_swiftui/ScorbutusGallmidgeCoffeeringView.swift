...
struct ScorbutusGallmidgeCoffeeringView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ScorbutusGallmidgeCoffeering")
    }
...
// Preview provider
struct ScorbutusGallmidgeCoffeeringView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ScorbutusGallmidgeCoffeeringView()
        }
    }
}
