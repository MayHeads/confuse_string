...
public struct AcrophonyTorreyaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AcrophonyTorreya")
    }
...
// Preview provider
public struct AcrophonyTorreyaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AcrophonyTorreyaView()
        }
    }
}
