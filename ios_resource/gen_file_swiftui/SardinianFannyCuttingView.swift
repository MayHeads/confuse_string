...
struct SardinianFannyCuttingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SardinianFannyCutting")
    }
...
// Preview provider
struct SardinianFannyCuttingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SardinianFannyCuttingView()
        }
    }
}
