...
struct ConstantquantityAstacusEstheteView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ConstantquantityAstacusEsthete")
    }
...
// Preview provider
struct ConstantquantityAstacusEstheteView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ConstantquantityAstacusEstheteView()
        }
    }
}
