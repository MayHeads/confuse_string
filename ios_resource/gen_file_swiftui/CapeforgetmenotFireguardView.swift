...
struct CapeforgetmenotFireguardView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CapeforgetmenotFireguard")
    }
...
// Preview provider
struct CapeforgetmenotFireguardView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CapeforgetmenotFireguardView()
        }
    }
}
