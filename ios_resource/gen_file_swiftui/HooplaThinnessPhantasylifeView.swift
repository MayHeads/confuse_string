...
public struct HooplaThinnessPhantasylifeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("HooplaThinnessPhantasylife")
    }
...
// Preview provider
public struct HooplaThinnessPhantasylifeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            HooplaThinnessPhantasylifeView()
        }
    }
}
