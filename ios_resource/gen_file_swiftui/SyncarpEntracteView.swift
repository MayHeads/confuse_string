...
public struct SyncarpEntracteView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SyncarpEntracte")
    }
...
// Preview provider
public struct SyncarpEntracteView_Previews: PreviewProvider {
