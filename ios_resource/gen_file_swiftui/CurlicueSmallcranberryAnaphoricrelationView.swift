...
struct CurlicueSmallcranberryAnaphoricrelationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CurlicueSmallcranberryAnaphoricrelation")
    }
...
// Preview provider
struct CurlicueSmallcranberryAnaphoricrelationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CurlicueSmallcranberryAnaphoricrelationView()
        }
    }
}
