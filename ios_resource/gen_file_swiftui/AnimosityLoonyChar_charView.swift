...
struct AnimosityLoonyChar_charView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AnimosityLoonyChar_char")
    }
...
// Preview provider
struct AnimosityLoonyChar_charView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AnimosityLoonyChar_charView()
        }
    }
}
