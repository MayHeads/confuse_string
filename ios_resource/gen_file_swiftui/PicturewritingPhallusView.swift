...
struct PicturewritingPhallusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PicturewritingPhallus")
    }
...
// Preview provider
struct PicturewritingPhallusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PicturewritingPhallusView()
        }
    }
}
