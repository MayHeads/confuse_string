...
struct AlphabetAnasatristisMedicalrelationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AlphabetAnasatristisMedicalrelation")
    }
...
// Preview provider
struct AlphabetAnasatristisMedicalrelationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AlphabetAnasatristisMedicalrelationView()
        }
    }
}
