...
public struct UblecrochetMagnetronView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("UblecrochetMagnetron")
    }
...
// Preview provider
public struct UblecrochetMagnetronView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            UblecrochetMagnetronView()
        }
    }
}
