...
public struct StatutorylawBunyabunyatreeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("StatutorylawBunyabunyatree")
    }
...
// Preview provider
public struct StatutorylawBunyabunyatreeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            StatutorylawBunyabunyatreeView()
        }
    }
}
