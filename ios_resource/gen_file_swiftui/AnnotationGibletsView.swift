...
public struct AnnotationGibletsView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AnnotationGiblets")
    }
...
// Preview provider
public struct AnnotationGibletsView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AnnotationGibletsView()
        }
    }
}
