...
public struct TensorUmpirageWrappingpaperView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("TensorUmpirageWrappingpaper")
    }
...
// Preview provider
public struct TensorUmpirageWrappingpaperView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TensorUmpirageWrappingpaperView()
        }
    }
}
