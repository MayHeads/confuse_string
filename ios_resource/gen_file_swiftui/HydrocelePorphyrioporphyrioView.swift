...
struct HydrocelePorphyrioporphyrioView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HydrocelePorphyrioporphyrio")
    }
...
// Preview provider
struct HydrocelePorphyrioporphyrioView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HydrocelePorphyrioporphyrioView()
        }
    }
}
