...
struct GenuscoelogyneHurdleraceUlvalesView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GenuscoelogyneHurdleraceUlvales")
    }
...
// Preview provider
struct GenuscoelogyneHurdleraceUlvalesView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GenuscoelogyneHurdleraceUlvalesView()
        }
    }
}
