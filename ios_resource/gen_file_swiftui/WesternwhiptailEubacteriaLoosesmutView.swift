...
struct WesternwhiptailEubacteriaLoosesmutView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WesternwhiptailEubacteriaLoosesmut")
    }
...
// Preview provider
struct WesternwhiptailEubacteriaLoosesmutView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WesternwhiptailEubacteriaLoosesmutView()
        }
    }
}
