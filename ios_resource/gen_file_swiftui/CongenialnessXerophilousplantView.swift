...
public struct CongenialnessXerophilousplantView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("CongenialnessXerophilousplant")
    }
...
// Preview provider
public struct CongenialnessXerophilousplantView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            CongenialnessXerophilousplantView()
        }
    }
}
