...
struct OrphanPseudemysscriptaPortraitView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OrphanPseudemysscriptaPortrait")
    }
...
// Preview provider
struct OrphanPseudemysscriptaPortraitView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OrphanPseudemysscriptaPortraitView()
        }
    }
}
