...
struct CumberlandriverGastromyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CumberlandriverGastromy")
    }
...
// Preview provider
struct CumberlandriverGastromyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CumberlandriverGastromyView()
        }
    }
}
