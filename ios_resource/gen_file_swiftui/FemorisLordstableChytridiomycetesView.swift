...
struct FemorisLordstableChytridiomycetesView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FemorisLordstableChytridiomycetes")
    }
...
// Preview provider
struct FemorisLordstableChytridiomycetesView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FemorisLordstableChytridiomycetesView()
        }
    }
}
