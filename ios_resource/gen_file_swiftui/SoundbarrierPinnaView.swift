...
public struct SoundbarrierPinnaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SoundbarrierPinna")
    }
...
// Preview provider
public struct SoundbarrierPinnaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SoundbarrierPinnaView()
        }
    }
}
