...
struct HeelTridacnidaeIdalfitrView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HeelTridacnidaeIdalfitr")
    }
...
// Preview provider
struct HeelTridacnidaeIdalfitrView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HeelTridacnidaeIdalfitrView()
        }
    }
}
