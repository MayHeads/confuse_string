...
struct NewscasterSupplyGaboroneView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NewscasterSupplyGaborone")
    }
...
// Preview provider
struct NewscasterSupplyGaboroneView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NewscasterSupplyGaboroneView()
        }
    }
}
