...
struct ArtnouveauStochasticvariableViewingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ArtnouveauStochasticvariableing")
    }
...
// Preview provider
struct ArtnouveauStochasticvariableViewingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ArtnouveauStochasticvariableViewingView()
        }
    }
}
