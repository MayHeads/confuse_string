...
struct FilbertShellGametangiumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FilbertShellGametangium")
    }
...
// Preview provider
struct FilbertShellGametangiumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FilbertShellGametangiumView()
        }
    }
}
