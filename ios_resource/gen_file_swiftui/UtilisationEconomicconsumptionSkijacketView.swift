...
struct UtilisationEconomicconsumptionSkijacketView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UtilisationEconomicconsumptionSkijacket")
    }
...
// Preview provider
struct UtilisationEconomicconsumptionSkijacketView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UtilisationEconomicconsumptionSkijacketView()
        }
    }
}
