...
struct LiparisloeseliiPlantainView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LiparisloeseliiPlantain")
    }
...
// Preview provider
struct LiparisloeseliiPlantainView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LiparisloeseliiPlantainView()
        }
    }
}
