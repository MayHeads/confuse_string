...
struct FilsCatch_catchRainbowtroutView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FilsCatch_catchRainbowtrout")
    }
...
// Preview provider
struct FilsCatch_catchRainbowtroutView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FilsCatch_catchRainbowtroutView()
        }
    }
}
