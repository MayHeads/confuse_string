...
struct PlacidnessNoblemanHornstoneView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PlacidnessNoblemanHornstone")
    }
...
// Preview provider
struct PlacidnessNoblemanHornstoneView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PlacidnessNoblemanHornstoneView()
        }
    }
}
