...
public struct EquetuslanceolatusStyleCrusherView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("bestowRecallBearberryAttendant")
                        .resizable()
        ...
        .navigationTitle("EquetuslanceolatusStyleCrusher")
    }
...
// Preview provider
public struct EquetuslanceolatusStyleCrusherView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            EquetuslanceolatusStyleCrusherView()
        }
    }
}
