...
struct MicronSafeManufacturerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MicronSafeManufacturer")
    }
...
// Preview provider
struct MicronSafeManufacturerView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MicronSafeManufacturerView()
        }
    }
}
