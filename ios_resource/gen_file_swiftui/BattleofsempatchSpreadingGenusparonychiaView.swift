...
public struct BattleofsempatchSpreadingGenusparonychiaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BattleofsempatchSpreadingGenusparonychia")
    }
...
// Preview provider
public struct BattleofsempatchSpreadingGenusparonychiaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BattleofsempatchSpreadingGenusparonychiaView()
        }
    }
}
