...
struct LaurelwreathPencilboxGenusokapiaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LaurelwreathPencilboxGenusokapia")
    }
...
// Preview provider
struct LaurelwreathPencilboxGenusokapiaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LaurelwreathPencilboxGenusokapiaView()
        }
    }
}
