...
public struct KinspersonBlankHazardiaView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("illuminateConjugatesolutionBalsaminaceae")
                        .resizable()
        ...
        .navigationTitle("KinspersonBlankHazardia")
    }
...
// Preview provider
public struct KinspersonBlankHazardiaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            KinspersonBlankHazardiaView()
        }
    }
}
