...
struct MarchingorderSatinetWoodinessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MarchingorderSatinetWoodiness")
    }
...
// Preview provider
struct MarchingorderSatinetWoodinessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MarchingorderSatinetWoodinessView()
        }
    }
}
