...
public struct MilkcowRaccoonfoxToolanddieworkView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MilkcowRaccoonfoxToolanddiework")
    }
...
// Preview provider
public struct MilkcowRaccoonfoxToolanddieworkView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MilkcowRaccoonfoxToolanddieworkView()
        }
    }
}
