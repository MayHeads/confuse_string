...
public struct BootyCapitaloflibyaElongationView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BootyCapitaloflibyaElongation")
    }
...
// Preview provider
public struct BootyCapitaloflibyaElongationView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BootyCapitaloflibyaElongationView()
        }
    }
}
