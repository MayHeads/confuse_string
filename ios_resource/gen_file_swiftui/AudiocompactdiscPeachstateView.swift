...
struct AudiocompactdiscPeachstateView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AudiocompactdiscPeachstate")
    }
...
// Preview provider
struct AudiocompactdiscPeachstateView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AudiocompactdiscPeachstateView()
        }
    }
}
