...
struct WhatforDeliberatenessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WhatforDeliberateness")
    }
...
// Preview provider
struct WhatforDeliberatenessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WhatforDeliberatenessView()
        }
    }
}
