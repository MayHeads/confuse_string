...
public struct DepilationEyedropView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("DepilationEyedrop")
    }
...
// Preview provider
public struct DepilationEyedropView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            DepilationEyedropView()
        }
    }
}
