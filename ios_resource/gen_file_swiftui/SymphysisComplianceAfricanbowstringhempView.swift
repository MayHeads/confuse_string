...
public struct SymphysisComplianceAfricanbowstringhempView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SymphysisComplianceAfricanbowstringhemp")
    }
...
// Preview provider
public struct SymphysisComplianceAfricanbowstringhempView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SymphysisComplianceAfricanbowstringhempView()
        }
    }
}
