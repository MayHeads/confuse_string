...
struct MonogenicdisorderAmyotrophiaPercophidaeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MonogenicdisorderAmyotrophiaPercophidae")
    }
...
// Preview provider
struct MonogenicdisorderAmyotrophiaPercophidaeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MonogenicdisorderAmyotrophiaPercophidaeView()
        }
    }
}
