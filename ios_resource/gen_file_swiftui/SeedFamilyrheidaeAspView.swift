...
struct SeedFamilyrheidaeAspView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SeedFamilyrheidaeAsp")
    }
...
// Preview provider
struct SeedFamilyrheidaeAspView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SeedFamilyrheidaeAspView()
        }
    }
}
