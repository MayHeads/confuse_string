...
struct FlytrapLaurencestephenlowryView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FlytrapLaurencestephenlowry")
    }
...
// Preview provider
struct FlytrapLaurencestephenlowryView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FlytrapLaurencestephenlowryView()
        }
    }
}
