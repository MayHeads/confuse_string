...
public struct LineObturatorveinSucculencyView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("LineObturatorveinSucculency")
    }
...
// Preview provider
public struct LineObturatorveinSucculencyView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            LineObturatorveinSucculencyView()
        }
    }
}
