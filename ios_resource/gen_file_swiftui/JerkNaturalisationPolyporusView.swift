...
struct JerkNaturalisationPolyporusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("JerkNaturalisationPolyporus")
    }
...
// Preview provider
struct JerkNaturalisationPolyporusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            JerkNaturalisationPolyporusView()
        }
    }
}
