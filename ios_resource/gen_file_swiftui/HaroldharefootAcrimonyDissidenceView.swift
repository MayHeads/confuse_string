...
public struct HaroldharefootAcrimonyDissidenceView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("HaroldharefootAcrimonyDissidence")
    }
...
// Preview provider
public struct HaroldharefootAcrimonyDissidenceView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            HaroldharefootAcrimonyDissidenceView()
        }
    }
}
