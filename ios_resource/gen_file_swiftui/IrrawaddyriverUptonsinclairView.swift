...
struct IrrawaddyriverUptonsinclairView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("IrrawaddyriverUptonsinclair")
    }
...
// Preview provider
struct IrrawaddyriverUptonsinclairView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            IrrawaddyriverUptonsinclairView()
        }
    }
}
