...
struct DemandforidentificationHereroView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DemandforidentificationHerero")
    }
...
// Preview provider
struct DemandforidentificationHereroView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DemandforidentificationHereroView()
        }
    }
}
