...
struct PiperbetelOctopusQuetzalbirdView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PiperbetelOctopusQuetzalbird")
    }
...
// Preview provider
struct PiperbetelOctopusQuetzalbirdView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PiperbetelOctopusQuetzalbirdView()
        }
    }
}
