...
struct ItaliaTablenapkinStartView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ItaliaTablenapkinStart")
    }
...
// Preview provider
struct ItaliaTablenapkinStartView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ItaliaTablenapkinStartView()
        }
    }
}
