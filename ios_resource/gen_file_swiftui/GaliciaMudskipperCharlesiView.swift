...
public struct GaliciaMudskipperCharlesiView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("GaliciaMudskipperCharlesi")
    }
...
// Preview provider
public struct GaliciaMudskipperCharlesiView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            GaliciaMudskipperCharlesiView()
        }
    }
}
