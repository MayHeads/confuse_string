...
struct GentianaluteaNewspapermanView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GentianaluteaNewspaperman")
    }
...
// Preview provider
struct GentianaluteaNewspapermanView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GentianaluteaNewspapermanView()
        }
    }
}
