...
public struct EndgameBubblerOrrisView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("EndgameBubblerOrris")
    }
...
// Preview provider
public struct EndgameBubblerOrrisView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            EndgameBubblerOrrisView()
        }
    }
}
