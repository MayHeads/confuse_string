...
struct JohnjosephmcgrawCryptanalyticsLavaboView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("JohnjosephmcgrawCryptanalyticsLavabo")
    }
...
// Preview provider
struct JohnjosephmcgrawCryptanalyticsLavaboView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            JohnjosephmcgrawCryptanalyticsLavaboView()
        }
    }
}
