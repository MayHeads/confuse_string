...
struct BilliejeanmoffittkingAtopiceczemaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BilliejeanmoffittkingAtopiceczema")
    }
...
// Preview provider
struct BilliejeanmoffittkingAtopiceczemaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BilliejeanmoffittkingAtopiceczemaView()
        }
    }
}
