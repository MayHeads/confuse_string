...
struct EvolutionarytrendDistressView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EvolutionarytrendDistress")
    }
...
// Preview provider
struct EvolutionarytrendDistressView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EvolutionarytrendDistressView()
        }
    }
}
