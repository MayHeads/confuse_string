...
public struct FuniculitisAbominationView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FuniculitisAbomination")
    }
...
// Preview provider
public struct FuniculitisAbominationView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FuniculitisAbominationView()
        }
    }
}
