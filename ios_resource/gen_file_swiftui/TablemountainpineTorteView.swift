...
public struct TablemountainpineTorteView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("TablemountainpineTorte")
    }
...
// Preview provider
public struct TablemountainpineTorteView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TablemountainpineTorteView()
        }
    }
}
