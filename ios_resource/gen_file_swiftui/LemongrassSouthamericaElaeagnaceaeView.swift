...
struct LemongrassSouthamericaElaeagnaceaeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LemongrassSouthamericaElaeagnaceae")
    }
...
// Preview provider
struct LemongrassSouthamericaElaeagnaceaeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LemongrassSouthamericaElaeagnaceaeView()
        }
    }
}
