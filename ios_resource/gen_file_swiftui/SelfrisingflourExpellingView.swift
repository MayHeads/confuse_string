...
struct SelfrisingflourExpellingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SelfrisingflourExpelling")
    }
...
// Preview provider
struct SelfrisingflourExpellingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SelfrisingflourExpellingView()
        }
    }
}
