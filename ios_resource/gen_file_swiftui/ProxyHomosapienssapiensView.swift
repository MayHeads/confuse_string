...
struct ProxyHomosapienssapiensView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ProxyHomosapienssapiens")
    }
...
// Preview provider
struct ProxyHomosapienssapiensView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ProxyHomosapienssapiensView()
        }
    }
}
