...
public struct OstryopsisScribbleView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("OstryopsisScribble")
    }
...
// Preview provider
public struct OstryopsisScribbleView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            OstryopsisScribbleView()
        }
    }
}
