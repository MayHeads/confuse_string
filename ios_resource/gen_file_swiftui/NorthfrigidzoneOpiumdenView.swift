...
struct NorthfrigidzoneOpiumdenView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NorthfrigidzoneOpiumden")
    }
...
// Preview provider
struct NorthfrigidzoneOpiumdenView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NorthfrigidzoneOpiumdenView()
        }
    }
}
