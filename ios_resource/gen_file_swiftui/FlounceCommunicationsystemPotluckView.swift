...
public struct FlounceCommunicationsystemPotluckView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FlounceCommunicationsystemPotluck")
    }
...
// Preview provider
public struct FlounceCommunicationsystemPotluckView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FlounceCommunicationsystemPotluckView()
        }
    }
}
