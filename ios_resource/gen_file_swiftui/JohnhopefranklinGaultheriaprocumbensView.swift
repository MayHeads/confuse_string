...
struct JohnhopefranklinGaultheriaprocumbensView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("JohnhopefranklinGaultheriaprocumbens")
    }
...
// Preview provider
struct JohnhopefranklinGaultheriaprocumbensView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            JohnhopefranklinGaultheriaprocumbensView()
        }
    }
}
