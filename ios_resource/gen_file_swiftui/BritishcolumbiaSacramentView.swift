...
struct BritishcolumbiaSacramentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BritishcolumbiaSacrament")
    }
...
// Preview provider
struct BritishcolumbiaSacramentView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BritishcolumbiaSacramentView()
        }
    }
}
