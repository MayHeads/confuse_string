...
struct WoodfernImbecilityNeedlespikerushView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WoodfernImbecilityNeedlespikerush")
    }
...
// Preview provider
struct WoodfernImbecilityNeedlespikerushView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WoodfernImbecilityNeedlespikerushView()
        }
    }
}
