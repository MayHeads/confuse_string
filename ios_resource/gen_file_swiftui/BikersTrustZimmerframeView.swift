...
struct BikersTrustZimmerframeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BikersTrustZimmerframe")
    }
...
// Preview provider
struct BikersTrustZimmerframeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BikersTrustZimmerframeView()
        }
    }
}
