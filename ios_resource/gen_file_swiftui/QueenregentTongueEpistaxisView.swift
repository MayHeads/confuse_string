...
struct QueenregentTongueEpistaxisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("QueenregentTongueEpistaxis")
    }
...
// Preview provider
struct QueenregentTongueEpistaxisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            QueenregentTongueEpistaxisView()
        }
    }
}
