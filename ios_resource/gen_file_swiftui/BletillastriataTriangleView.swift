...
public struct BletillastriataTriangleView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BletillastriataTriangle")
    }
...
// Preview provider
public struct BletillastriataTriangleView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BletillastriataTriangleView()
        }
    }
}
