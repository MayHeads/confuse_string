...
struct MithraicismObligationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MithraicismObligation")
    }
...
// Preview provider
struct MithraicismObligationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MithraicismObligationView()
        }
    }
}
