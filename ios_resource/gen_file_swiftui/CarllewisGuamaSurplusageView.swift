...
public struct CarllewisGuamaSurplusageView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("CarllewisGuamaSurplusage")
    }
...
// Preview provider
public struct CarllewisGuamaSurplusageView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            CarllewisGuamaSurplusageView()
        }
    }
}
