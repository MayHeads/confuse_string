...
public struct TreasuryEggwhiteView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("TreasuryEggwhite")
    }
...
// Preview provider
public struct TreasuryEggwhiteView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TreasuryEggwhiteView()
        }
    }
}
