...
struct UnbalanceSwanflowerNeurosisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UnbalanceSwanflowerNeurosis")
    }
...
// Preview provider
struct UnbalanceSwanflowerNeurosisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UnbalanceSwanflowerNeurosisView()
        }
    }
}
