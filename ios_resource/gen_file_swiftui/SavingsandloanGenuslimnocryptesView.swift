...
public struct SavingsandloanGenuslimnocryptesView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SavingsandloanGenuslimnocryptes")
    }
...
// Preview provider
public struct SavingsandloanGenuslimnocryptesView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SavingsandloanGenuslimnocryptesView()
        }
    }
}
