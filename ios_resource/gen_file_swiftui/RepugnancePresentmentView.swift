...
struct RepugnancePresentmentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("RepugnancePresentment")
    }
...
// Preview provider
struct RepugnancePresentmentView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RepugnancePresentmentView()
        }
    }
}
