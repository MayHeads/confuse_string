...
struct AlaskankingcrabFalldandelionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AlaskankingcrabFalldandelion")
    }
...
// Preview provider
struct AlaskankingcrabFalldandelionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AlaskankingcrabFalldandelionView()
        }
    }
}
