...
struct TelephonenumberIlkProboscisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TelephonenumberIlkProboscis")
    }
...
// Preview provider
struct TelephonenumberIlkProboscisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TelephonenumberIlkProboscisView()
        }
    }
}
