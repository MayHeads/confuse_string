...
struct KeithrupertmurchYellowoakView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("KeithrupertmurchYellowoak")
    }
...
// Preview provider
struct KeithrupertmurchYellowoakView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            KeithrupertmurchYellowoakView()
        }
    }
}
