...
struct SchoolcraftSensitivityDonaldduckView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SchoolcraftSensitivityDonaldduck")
    }
...
// Preview provider
struct SchoolcraftSensitivityDonaldduckView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SchoolcraftSensitivityDonaldduckView()
        }
    }
}
