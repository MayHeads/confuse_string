...
public struct MagnateCetoniaLamiaceaeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MagnateCetoniaLamiaceae")
    }
...
// Preview provider
public struct MagnateCetoniaLamiaceaeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MagnateCetoniaLamiaceaeView()
        }
    }
}
