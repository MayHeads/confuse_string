...
struct ExpulsionSchoolmanCondemnationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ExpulsionSchoolmanCondemnation")
    }
...
// Preview provider
struct ExpulsionSchoolmanCondemnationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ExpulsionSchoolmanCondemnationView()
        }
    }
}
