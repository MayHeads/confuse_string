...
struct FdrooseveltWrightSayeretView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FdrooseveltWrightSayeret")
    }
...
// Preview provider
struct FdrooseveltWrightSayeretView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FdrooseveltWrightSayeretView()
        }
    }
}
