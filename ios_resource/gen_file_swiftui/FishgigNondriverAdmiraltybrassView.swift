...
struct FishgigNondriverAdmiraltybrassView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FishgigNondriverAdmiraltybrass")
    }
...
// Preview provider
struct FishgigNondriverAdmiraltybrassView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FishgigNondriverAdmiraltybrassView()
        }
    }
}
