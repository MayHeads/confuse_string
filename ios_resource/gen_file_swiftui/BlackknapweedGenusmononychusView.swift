...
struct BlackknapweedGenusmononychusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BlackknapweedGenusmononychus")
    }
...
// Preview provider
struct BlackknapweedGenusmononychusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlackknapweedGenusmononychusView()
        }
    }
}
