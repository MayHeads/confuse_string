...
public struct HaemoproteidRecalcitranceView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("HaemoproteidRecalcitrance")
    }
...
// Preview provider
public struct HaemoproteidRecalcitranceView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            HaemoproteidRecalcitranceView()
        }
    }
}
