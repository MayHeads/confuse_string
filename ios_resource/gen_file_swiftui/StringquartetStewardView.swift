...
struct StringquartetStewardView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("StringquartetSteward")
    }
...
// Preview provider
struct StringquartetStewardView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            StringquartetStewardView()
        }
    }
}
