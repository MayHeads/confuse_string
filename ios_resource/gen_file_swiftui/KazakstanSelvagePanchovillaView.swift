...
struct KazakstanSelvagePanchovillaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("KazakstanSelvagePanchovilla")
    }
...
// Preview provider
struct KazakstanSelvagePanchovillaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            KazakstanSelvagePanchovillaView()
        }
    }
}
