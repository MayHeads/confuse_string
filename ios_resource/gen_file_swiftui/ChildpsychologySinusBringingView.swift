...
public struct ChildpsychologySinusBringingView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ChildpsychologySinusBringing")
    }
...
// Preview provider
public struct ChildpsychologySinusBringingView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ChildpsychologySinusBringingView()
        }
    }
}
