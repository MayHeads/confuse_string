...
struct TrebuchetSuicidemissionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TrebuchetSuicidemission")
    }
...
// Preview provider
struct TrebuchetSuicidemissionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TrebuchetSuicidemissionView()
        }
    }
}
