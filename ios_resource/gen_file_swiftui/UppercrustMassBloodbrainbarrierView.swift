...
public struct UppercrustMassBloodbrainbarrierView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("UppercrustMassBloodbrainbarrier")
    }
...
// Preview provider
public struct UppercrustMassBloodbrainbarrierView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            UppercrustMassBloodbrainbarrierView()
        }
    }
}
