...
public struct FireboxFakeryHobbitView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FireboxFakeryHobbit")
    }
...
// Preview provider
public struct FireboxFakeryHobbitView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FireboxFakeryHobbitView()
        }
    }
}
