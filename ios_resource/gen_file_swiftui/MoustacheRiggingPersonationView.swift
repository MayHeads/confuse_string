...
struct MoustacheRiggingPersonationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MoustacheRiggingPersonation")
    }
...
// Preview provider
struct MoustacheRiggingPersonationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MoustacheRiggingPersonationView()
        }
    }
}
