...
struct IntangibilityKingcrabView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("IntangibilityKingcrab")
    }
...
// Preview provider
struct IntangibilityKingcrabView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            IntangibilityKingcrabView()
        }
    }
}
