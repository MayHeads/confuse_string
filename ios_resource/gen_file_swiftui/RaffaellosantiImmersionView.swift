...
public struct RaffaellosantiImmersionView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("RaffaellosantiImmersion")
    }
...
// Preview provider
public struct RaffaellosantiImmersionView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            RaffaellosantiImmersionView()
        }
    }
}
