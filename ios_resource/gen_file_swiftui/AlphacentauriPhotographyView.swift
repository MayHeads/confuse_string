...
public struct AlphacentauriPhotographyView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AlphacentauriPhotography")
    }
...
// Preview provider
public struct AlphacentauriPhotographyView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AlphacentauriPhotographyView()
        }
    }
}
