...
struct TurtleHypocellularityTularaemiaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TurtleHypocellularityTularaemia")
    }
...
// Preview provider
struct TurtleHypocellularityTularaemiaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TurtleHypocellularityTularaemiaView()
        }
    }
}
