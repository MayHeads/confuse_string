...
struct PersonalcreditlinePolkatView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PersonalcreditlinePolkat")
    }
...
// Preview provider
struct PersonalcreditlinePolkatView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PersonalcreditlinePolkatView()
        }
    }
}
