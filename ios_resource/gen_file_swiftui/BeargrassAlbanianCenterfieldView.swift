...
public struct BeargrassAlbanianCenterfieldView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BeargrassAlbanianCenterfield")
    }
...
// Preview provider
public struct BeargrassAlbanianCenterfieldView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BeargrassAlbanianCenterfieldView()
        }
    }
}
