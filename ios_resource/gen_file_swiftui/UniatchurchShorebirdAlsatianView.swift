...
public struct UniatchurchShorebirdAlsatianView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("consultDistrictDevonshirecream")
                        .resizable()
        ...
        .navigationTitle("UniatchurchShorebirdAlsatian")
    }
...
// Preview provider
public struct UniatchurchShorebirdAlsatianView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            UniatchurchShorebirdAlsatianView()
        }
    }
}
