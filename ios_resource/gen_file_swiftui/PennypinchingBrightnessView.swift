...
struct PennypinchingBrightnessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PennypinchingBrightness")
    }
...
// Preview provider
struct PennypinchingBrightnessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PennypinchingBrightnessView()
        }
    }
}
