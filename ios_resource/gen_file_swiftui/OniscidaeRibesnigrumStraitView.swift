...
struct OniscidaeRibesnigrumStraitView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OniscidaeRibesnigrumStrait")
    }
...
// Preview provider
struct OniscidaeRibesnigrumStraitView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OniscidaeRibesnigrumStraitView()
        }
    }
}
