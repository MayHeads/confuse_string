...
public struct FursealCarlrogersOstarsifibulareView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FursealCarlrogersOstarsifibulare")
    }
...
// Preview provider
public struct FursealCarlrogersOstarsifibulareView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FursealCarlrogersOstarsifibulareView()
        }
    }
}
