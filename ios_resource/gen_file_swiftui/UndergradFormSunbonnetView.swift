...
public struct UndergradFormSunbonnetView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("UndergradFormSunbonnet")
    }
...
// Preview provider
public struct UndergradFormSunbonnetView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            UndergradFormSunbonnetView()
        }
    }
}
