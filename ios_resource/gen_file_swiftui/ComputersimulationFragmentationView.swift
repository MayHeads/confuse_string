...
public struct ComputersimulationFragmentationView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("startTranscendPancakeHomeotherm")
                        .resizable()
                    ...
                    Image("lifehackVapourbathPrimateship")
                        .resizable()
                        .frame(height: 100)
                        .opacity(0.5)
                }
        ...
        .navigationTitle("ComputersimulationFragmentation")
    }
...
// Preview provider
public struct ComputersimulationFragmentationView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ComputersimulationFragmentationView()
        }
    }
}
