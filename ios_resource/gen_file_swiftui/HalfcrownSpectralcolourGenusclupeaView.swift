...
public struct HalfcrownSpectralcolourGenusclupeaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("HalfcrownSpectralcolourGenusclupea")
    }
...
// Preview provider
public struct HalfcrownSpectralcolourGenusclupeaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            HalfcrownSpectralcolourGenusclupeaView()
        }
    }
}
