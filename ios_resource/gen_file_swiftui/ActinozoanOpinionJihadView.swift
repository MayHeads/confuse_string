...
struct ActinozoanOpinionJihadView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ActinozoanOpinionJihad")
    }
...
// Preview provider
struct ActinozoanOpinionJihadView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ActinozoanOpinionJihadView()
        }
    }
}
