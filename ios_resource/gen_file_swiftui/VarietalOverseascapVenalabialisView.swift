...
public struct VarietalOverseascapVenalabialisView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("VarietalOverseascapVenalabialis")
    }
...
// Preview provider
public struct VarietalOverseascapVenalabialisView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            VarietalOverseascapVenalabialisView()
        }
    }
}
