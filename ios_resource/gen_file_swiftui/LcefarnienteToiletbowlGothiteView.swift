...
struct LcefarnienteToiletbowlGothiteView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LcefarnienteToiletbowlGothite")
    }
...
// Preview provider
struct LcefarnienteToiletbowlGothiteView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LcefarnienteToiletbowlGothiteView()
        }
    }
}
