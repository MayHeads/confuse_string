...
struct FamilyebenaceaeNewphaseofthemoonView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FamilyebenaceaeNewphaseofthemoon")
    }
...
// Preview provider
struct FamilyebenaceaeNewphaseofthemoonView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FamilyebenaceaeNewphaseofthemoonView()
        }
    }
}
