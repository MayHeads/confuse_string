...
struct ChiefconstableDardanellescampaignView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ChiefconstableDardanellescampaign")
    }
...
// Preview provider
struct ChiefconstableDardanellescampaignView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ChiefconstableDardanellescampaignView()
        }
    }
}
