...
struct JansteenTrygvehalvdenlieView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("JansteenTrygvehalvdenlie")
    }
...
// Preview provider
struct JansteenTrygvehalvdenlieView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            JansteenTrygvehalvdenlieView()
        }
    }
}
