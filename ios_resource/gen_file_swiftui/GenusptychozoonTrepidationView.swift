...
struct GenusptychozoonTrepidationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GenusptychozoonTrepidation")
    }
...
// Preview provider
struct GenusptychozoonTrepidationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GenusptychozoonTrepidationView()
        }
    }
}
