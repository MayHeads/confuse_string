...
struct PunctuatedequilibriumLectorHogplumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PunctuatedequilibriumLectorHogplum")
    }
...
// Preview provider
struct PunctuatedequilibriumLectorHogplumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PunctuatedequilibriumLectorHogplumView()
        }
    }
}
