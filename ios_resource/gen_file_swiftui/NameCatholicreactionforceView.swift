...
struct NameCatholicreactionforceView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NameCatholicreactionforce")
    }
...
// Preview provider
struct NameCatholicreactionforceView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NameCatholicreactionforceView()
        }
    }
}
