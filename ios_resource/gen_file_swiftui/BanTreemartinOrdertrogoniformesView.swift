...
public struct BanTreemartinOrdertrogoniformesView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BanTreemartinOrdertrogoniformes")
    }
...
// Preview provider
public struct BanTreemartinOrdertrogoniformesView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BanTreemartinOrdertrogoniformesView()
        }
    }
}
