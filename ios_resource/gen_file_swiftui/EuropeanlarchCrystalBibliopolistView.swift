...
struct EuropeanlarchCrystalBibliopolistView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EuropeanlarchCrystalBibliopolist")
    }
...
// Preview provider
struct EuropeanlarchCrystalBibliopolistView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EuropeanlarchCrystalBibliopolistView()
        }
    }
}
