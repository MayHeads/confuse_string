...
struct TrogoniformesMedalistBlackseabassView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TrogoniformesMedalistBlackseabass")
    }
...
// Preview provider
struct TrogoniformesMedalistBlackseabassView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TrogoniformesMedalistBlackseabassView()
        }
    }
}
