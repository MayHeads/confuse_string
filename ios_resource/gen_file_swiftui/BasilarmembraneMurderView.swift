...
struct BasilarmembraneMurderView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BasilarmembraneMurder")
    }
...
// Preview provider
struct BasilarmembraneMurderView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BasilarmembraneMurderView()
        }
    }
}
