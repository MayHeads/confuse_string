...
struct HystricomorphaScalenemuscleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HystricomorphaScalenemuscle")
    }
...
// Preview provider
struct HystricomorphaScalenemuscleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HystricomorphaScalenemuscleView()
        }
    }
}
