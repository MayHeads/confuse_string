...
public struct VioladamoreCapepasseroView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("VioladamoreCapepassero")
    }
...
// Preview provider
public struct VioladamoreCapepasseroView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            VioladamoreCapepasseroView()
        }
    }
}
