...
public struct FiestaGuidelineCarloanView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FiestaGuidelineCarloan")
    }
...
// Preview provider
public struct FiestaGuidelineCarloanView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FiestaGuidelineCarloanView()
        }
    }
}
