...
struct ProteusanguinusGaliummollugoPuckerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ProteusanguinusGaliummollugoPucker")
    }
...
// Preview provider
struct ProteusanguinusGaliummollugoPuckerView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ProteusanguinusGaliummollugoPuckerView()
        }
    }
}
