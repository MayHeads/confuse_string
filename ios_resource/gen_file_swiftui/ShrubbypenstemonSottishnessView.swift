...
struct ShrubbypenstemonSottishnessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ShrubbypenstemonSottishness")
    }
...
// Preview provider
struct ShrubbypenstemonSottishnessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ShrubbypenstemonSottishnessView()
        }
    }
}
