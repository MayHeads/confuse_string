...
public struct IndividuationNicaeaView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    ...
                    Image("tissuePerplexMeltRetrospection")
                        .resizable()
                        .frame(height: 100)
                        .opacity(0.5)
                }
        ...
        .navigationTitle("IndividuationNicaea")
    }
...
// Preview provider
public struct IndividuationNicaeaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            IndividuationNicaeaView()
        }
    }
}
