...
public struct SpirocheteFoxterrierAdansoniagregoriiView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SpirocheteFoxterrierAdansoniagregorii")
    }
...
// Preview provider
public struct SpirocheteFoxterrierAdansoniagregoriiView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SpirocheteFoxterrierAdansoniagregoriiView()
        }
    }
}
