...
public struct EssentialtremorIndirectobjectView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("EssentialtremorIndirectobject")
    }
...
// Preview provider
public struct EssentialtremorIndirectobjectView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            EssentialtremorIndirectobjectView()
        }
    }
}
