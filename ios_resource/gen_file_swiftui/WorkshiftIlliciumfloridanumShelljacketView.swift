...
struct WorkshiftIlliciumfloridanumShelljacketView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WorkshiftIlliciumfloridanumShelljacket")
    }
...
// Preview provider
struct WorkshiftIlliciumfloridanumShelljacketView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WorkshiftIlliciumfloridanumShelljacketView()
        }
    }
}
