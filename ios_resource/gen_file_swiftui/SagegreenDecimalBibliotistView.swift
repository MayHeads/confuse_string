...
public struct SagegreenDecimalBibliotistView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SagegreenDecimalBibliotist")
    }
...
// Preview provider
public struct SagegreenDecimalBibliotistView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SagegreenDecimalBibliotistView()
        }
    }
}
