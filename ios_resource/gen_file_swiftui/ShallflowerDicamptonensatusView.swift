...
struct ShallflowerDicamptonensatusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ShallflowerDicamptonensatus")
    }
...
// Preview provider
struct ShallflowerDicamptonensatusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ShallflowerDicamptonensatusView()
        }
    }
}
