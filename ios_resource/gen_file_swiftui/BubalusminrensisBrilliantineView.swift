...
struct BubalusminrensisBrilliantineView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BubalusminrensisBrilliantine")
    }
...
// Preview provider
struct BubalusminrensisBrilliantineView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BubalusminrensisBrilliantineView()
        }
    }
}
