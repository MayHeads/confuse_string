...
public struct TracthousingWholewheatflourView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("hittheceilingManageAkkoNgultrum")
                        .resizable()
        ...
        .navigationTitle("TracthousingWholewheatflour")
    }
...
// Preview provider
public struct TracthousingWholewheatflourView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TracthousingWholewheatflourView()
        }
    }
}
