...
struct SummingupSomataesthesisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SummingupSomataesthesis")
    }
...
// Preview provider
struct SummingupSomataesthesisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SummingupSomataesthesisView()
        }
    }
}
