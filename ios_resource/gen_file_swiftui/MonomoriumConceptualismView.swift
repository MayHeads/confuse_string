...
struct MonomoriumConceptualismView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MonomoriumConceptualism")
    }
...
// Preview provider
struct MonomoriumConceptualismView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MonomoriumConceptualismView()
        }
    }
}
