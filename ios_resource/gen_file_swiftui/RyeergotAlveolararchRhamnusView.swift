...
public struct RyeergotAlveolararchRhamnusView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    ...
                    Image("distrustCarpocapsaDesiccant")
                        .resizable()
                        .frame(height: 100)
                        .opacity(0.5)
                }
        ...
        .navigationTitle("RyeergotAlveolararchRhamnus")
    }
...
// Preview provider
public struct RyeergotAlveolararchRhamnusView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            RyeergotAlveolararchRhamnusView()
        }
    }
}
