...
struct SoftfinnedfishSwampfeverCarboloadingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SoftfinnedfishSwampfeverCarboloading")
    }
...
// Preview provider
struct SoftfinnedfishSwampfeverCarboloadingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SoftfinnedfishSwampfeverCarboloadingView()
        }
    }
}
