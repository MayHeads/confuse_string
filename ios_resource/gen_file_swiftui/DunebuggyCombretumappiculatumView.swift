...
struct DunebuggyCombretumappiculatumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DunebuggyCombretumappiculatum")
    }
...
// Preview provider
struct DunebuggyCombretumappiculatumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DunebuggyCombretumappiculatumView()
        }
    }
}
