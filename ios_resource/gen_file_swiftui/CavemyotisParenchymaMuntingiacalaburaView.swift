...
public struct CavemyotisParenchymaMuntingiacalaburaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("CavemyotisParenchymaMuntingiacalabura")
    }
...
// Preview provider
public struct CavemyotisParenchymaMuntingiacalaburaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            CavemyotisParenchymaMuntingiacalaburaView()
        }
    }
}
