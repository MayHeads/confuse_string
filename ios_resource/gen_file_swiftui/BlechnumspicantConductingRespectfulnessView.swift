...
struct BlechnumspicantConductingRespectfulnessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BlechnumspicantConductingRespectfulness")
    }
...
// Preview provider
struct BlechnumspicantConductingRespectfulnessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlechnumspicantConductingRespectfulnessView()
        }
    }
}
