...
public struct WismPhylumpyrrophytaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("WismPhylumpyrrophyta")
    }
...
// Preview provider
public struct WismPhylumpyrrophytaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            WismPhylumpyrrophytaView()
        }
    }
}
