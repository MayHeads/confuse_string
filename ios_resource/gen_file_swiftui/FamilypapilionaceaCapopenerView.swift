...
public struct FamilypapilionaceaCapopenerView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FamilypapilionaceaCapopener")
    }
...
// Preview provider
public struct FamilypapilionaceaCapopenerView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FamilypapilionaceaCapopenerView()
        }
    }
}
