...
struct BemusementWaterstriderView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BemusementWaterstrider")
    }
...
// Preview provider
struct BemusementWaterstriderView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BemusementWaterstriderView()
        }
    }
}
