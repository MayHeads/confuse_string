...
public struct GeorgehuntingtonGenusptilonorhynchusRagView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("sanctionDisadvantageTetradecanoicacidGenusmenopon")
                        .resizable()
        ...
        .navigationTitle("GeorgehuntingtonGenusptilonorhynchusRag")
    }
...
// Preview provider
public struct GeorgehuntingtonGenusptilonorhynchusRagView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            GeorgehuntingtonGenusptilonorhynchusRagView()
        }
    }
}
