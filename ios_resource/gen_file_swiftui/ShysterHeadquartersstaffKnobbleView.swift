...
struct ShysterHeadquartersstaffKnobbleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ShysterHeadquartersstaffKnobble")
    }
...
// Preview provider
struct ShysterHeadquartersstaffKnobbleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ShysterHeadquartersstaffKnobbleView()
        }
    }
}
