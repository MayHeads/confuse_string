...
struct SimulationCentromereView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SimulationCentromere")
    }
...
// Preview provider
struct SimulationCentromereView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SimulationCentromereView()
        }
    }
}
