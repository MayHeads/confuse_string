...
struct PyrexSprucenessLoculusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PyrexSprucenessLoculus")
    }
...
// Preview provider
struct PyrexSprucenessLoculusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PyrexSprucenessLoculusView()
        }
    }
}
