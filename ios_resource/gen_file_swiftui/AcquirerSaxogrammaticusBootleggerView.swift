...
public struct AcquirerSaxogrammaticusBootleggerView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AcquirerSaxogrammaticusBootlegger")
    }
...
// Preview provider
public struct AcquirerSaxogrammaticusBootleggerView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AcquirerSaxogrammaticusBootleggerView()
        }
    }
}
