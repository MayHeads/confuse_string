...
struct EscapevelocityBatisFarinaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EscapevelocityBatisFarina")
    }
...
// Preview provider
struct EscapevelocityBatisFarinaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EscapevelocityBatisFarinaView()
        }
    }
}
