...
struct IndianmallowHenryleeWilhelmostwaldView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("IndianmallowHenryleeWilhelmostwald")
    }
...
// Preview provider
struct IndianmallowHenryleeWilhelmostwaldView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            IndianmallowHenryleeWilhelmostwaldView()
        }
    }
}
