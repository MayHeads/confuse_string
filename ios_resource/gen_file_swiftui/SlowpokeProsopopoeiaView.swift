...
struct SlowpokeProsopopoeiaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SlowpokeProsopopoeia")
    }
...
// Preview provider
struct SlowpokeProsopopoeiaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SlowpokeProsopopoeiaView()
        }
    }
}
