...
public struct WhitemangroveAdmiraltylawView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("WhitemangroveAdmiraltylaw")
    }
...
// Preview provider
public struct WhitemangroveAdmiraltylawView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            WhitemangroveAdmiraltylawView()
        }
    }
}
