...
public struct ColeonyxScrumpyAcaciaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ColeonyxScrumpyAcacia")
    }
...
// Preview provider
public struct ColeonyxScrumpyAcaciaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ColeonyxScrumpyAcaciaView()
        }
    }
}
