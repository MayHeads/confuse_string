...
struct CoproliteCaptainshipView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CoproliteCaptainship")
    }
...
// Preview provider
struct CoproliteCaptainshipView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CoproliteCaptainshipView()
        }
    }
}
