...
public struct ShindyKuenlunmountainsView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ShindyKuenlunmountains")
    }
...
// Preview provider
public struct ShindyKuenlunmountainsView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ShindyKuenlunmountainsView()
        }
    }
}
