...
public struct ParagoniteChanceCapitaloftogoView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ParagoniteChanceCapitaloftogo")
    }
...
// Preview provider
public struct ParagoniteChanceCapitaloftogoView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ParagoniteChanceCapitaloftogoView()
        }
    }
}
