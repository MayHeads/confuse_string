...
public struct TransparentnessYarmelkeCuscutaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("TransparentnessYarmelkeCuscuta")
    }
...
// Preview provider
public struct TransparentnessYarmelkeCuscutaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TransparentnessYarmelkeCuscutaView()
        }
    }
}
