...
public struct GenusmyosotisStrivingSectorView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("GenusmyosotisStrivingSector")
    }
...
// Preview provider
public struct GenusmyosotisStrivingSectorView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            GenusmyosotisStrivingSectorView()
        }
    }
}
