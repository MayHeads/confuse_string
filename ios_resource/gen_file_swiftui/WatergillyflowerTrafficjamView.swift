...
struct WatergillyflowerTrafficjamView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WatergillyflowerTrafficjam")
    }
...
// Preview provider
struct WatergillyflowerTrafficjamView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WatergillyflowerTrafficjamView()
        }
    }
}
