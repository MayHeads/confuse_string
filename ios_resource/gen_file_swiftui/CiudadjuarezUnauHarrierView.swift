...
struct CiudadjuarezUnauHarrierView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CiudadjuarezUnauHarrier")
    }
...
// Preview provider
struct CiudadjuarezUnauHarrierView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CiudadjuarezUnauHarrierView()
        }
    }
}
