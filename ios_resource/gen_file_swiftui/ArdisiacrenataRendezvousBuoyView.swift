...
struct ArdisiacrenataRendezvousBuoyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ArdisiacrenataRendezvousBuoy")
    }
...
// Preview provider
struct ArdisiacrenataRendezvousBuoyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ArdisiacrenataRendezvousBuoyView()
        }
    }
}
