...
struct OrganificationConvenienceFactionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OrganificationConvenienceFaction")
    }
...
// Preview provider
struct OrganificationConvenienceFactionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OrganificationConvenienceFactionView()
        }
    }
}
