...
struct DividerAplectrumhyemaleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DividerAplectrumhyemale")
    }
...
// Preview provider
struct DividerAplectrumhyemaleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DividerAplectrumhyemaleView()
        }
    }
}
