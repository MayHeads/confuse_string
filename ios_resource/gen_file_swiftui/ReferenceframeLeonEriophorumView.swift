...
struct ReferenceframeLeonEriophorumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ReferenceframeLeonEriophorum")
    }
...
// Preview provider
struct ReferenceframeLeonEriophorumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ReferenceframeLeonEriophorumView()
        }
    }
}
