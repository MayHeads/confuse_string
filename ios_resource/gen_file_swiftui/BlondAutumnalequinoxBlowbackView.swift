...
struct BlondAutumnalequinoxBlowbackView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BlondAutumnalequinoxBlowback")
    }
...
// Preview provider
struct BlondAutumnalequinoxBlowbackView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlondAutumnalequinoxBlowbackView()
        }
    }
}
