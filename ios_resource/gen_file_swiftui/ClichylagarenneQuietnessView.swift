...
struct ClichylagarenneQuietnessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ClichylagarenneQuietness")
    }
...
// Preview provider
struct ClichylagarenneQuietnessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ClichylagarenneQuietnessView()
        }
    }
}
