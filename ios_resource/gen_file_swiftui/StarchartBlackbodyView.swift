...
public struct StarchartBlackbodyView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("StarchartBlackbody")
    }
...
// Preview provider
public struct StarchartBlackbodyView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            StarchartBlackbodyView()
        }
    }
}
