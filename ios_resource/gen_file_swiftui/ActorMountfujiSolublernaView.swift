...
struct ActorMountfujiSolublernaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ActorMountfujiSolublerna")
    }
...
// Preview provider
struct ActorMountfujiSolublernaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ActorMountfujiSolublernaView()
        }
    }
}
