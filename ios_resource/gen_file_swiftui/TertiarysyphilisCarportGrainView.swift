...
struct TertiarysyphilisCarportGrainView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TertiarysyphilisCarportGrain")
    }
...
// Preview provider
struct TertiarysyphilisCarportGrainView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TertiarysyphilisCarportGrainView()
        }
    }
}
