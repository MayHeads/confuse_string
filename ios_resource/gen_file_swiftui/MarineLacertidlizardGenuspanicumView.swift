...
struct MarineLacertidlizardGenuspanicumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MarineLacertidlizardGenuspanicum")
    }
...
// Preview provider
struct MarineLacertidlizardGenuspanicumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MarineLacertidlizardGenuspanicumView()
        }
    }
}
