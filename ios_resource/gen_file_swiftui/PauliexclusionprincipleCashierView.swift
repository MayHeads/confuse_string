...
struct PauliexclusionprincipleCashierView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PauliexclusionprincipleCashier")
    }
...
// Preview provider
struct PauliexclusionprincipleCashierView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PauliexclusionprincipleCashierView()
        }
    }
}
