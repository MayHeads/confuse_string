...
struct CrumbcakeQuanngTurdusmigratoriusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CrumbcakeQuanngTurdusmigratorius")
    }
...
// Preview provider
struct CrumbcakeQuanngTurdusmigratoriusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CrumbcakeQuanngTurdusmigratoriusView()
        }
    }
}
