...
struct CanadiangoldenrodBostonbakedbeansView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CanadiangoldenrodBostonbakedbeans")
    }
...
// Preview provider
struct CanadiangoldenrodBostonbakedbeansView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CanadiangoldenrodBostonbakedbeansView()
        }
    }
}
