...
struct VaporizationHaikRasputinView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("VaporizationHaikRasputin")
    }
...
// Preview provider
struct VaporizationHaikRasputinView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            VaporizationHaikRasputinView()
        }
    }
}
