...
struct CadDisorientationSchutzstaffelView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CadDisorientationSchutzstaffel")
    }
...
// Preview provider
struct CadDisorientationSchutzstaffelView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CadDisorientationSchutzstaffelView()
        }
    }
}
