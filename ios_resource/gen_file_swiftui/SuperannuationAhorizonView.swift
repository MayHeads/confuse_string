...
struct SuperannuationAhorizonView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SuperannuationAhorizon")
    }
...
// Preview provider
struct SuperannuationAhorizonView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SuperannuationAhorizonView()
        }
    }
}
