...
public struct NephralgiaMondrianView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("NephralgiaMondrian")
    }
...
// Preview provider
public struct NephralgiaMondrianView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            NephralgiaMondrianView()
        }
    }
}
