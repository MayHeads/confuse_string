...
struct InterstitialtissueBarrelrollView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("InterstitialtissueBarrelroll")
    }
...
// Preview provider
struct InterstitialtissueBarrelrollView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            InterstitialtissueBarrelrollView()
        }
    }
}
