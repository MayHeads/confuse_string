...
struct CopperbasealloyMeaninglessnessView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CopperbasealloyMeaninglessness")
    }
...
// Preview provider
struct CopperbasealloyMeaninglessnessView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CopperbasealloyMeaninglessnessView()
        }
    }
}
