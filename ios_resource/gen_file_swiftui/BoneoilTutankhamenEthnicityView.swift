...
struct BoneoilTutankhamenEthnicityView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BoneoilTutankhamenEthnicity")
    }
...
// Preview provider
struct BoneoilTutankhamenEthnicityView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BoneoilTutankhamenEthnicityView()
        }
    }
}
