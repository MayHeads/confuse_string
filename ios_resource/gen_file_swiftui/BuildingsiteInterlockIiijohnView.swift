...
struct BuildingsiteInterlockIiijohnView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BuildingsiteInterlockIiijohn")
    }
...
// Preview provider
struct BuildingsiteInterlockIiijohnView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BuildingsiteInterlockIiijohnView()
        }
    }
}
