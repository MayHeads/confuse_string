...
public struct SaragossaBanglaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SaragossaBangla")
    }
...
// Preview provider
public struct SaragossaBanglaView_Previews: PreviewProvider {
