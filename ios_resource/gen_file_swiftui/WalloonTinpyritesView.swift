...
public struct WalloonTinpyritesView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("WalloonTinpyrites")
    }
...
// Preview provider
public struct WalloonTinpyritesView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            WalloonTinpyritesView()
        }
    }
}
