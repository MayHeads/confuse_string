...
public struct LumbermanssawLettererView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("LumbermanssawLetterer")
    }
...
// Preview provider
public struct LumbermanssawLettererView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            LumbermanssawLettererView()
        }
    }
}
