...
struct OrdertestudinataElodeaLodgementView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OrdertestudinataElodeaLodgement")
    }
...
// Preview provider
struct OrdertestudinataElodeaLodgementView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OrdertestudinataElodeaLodgementView()
        }
    }
}
