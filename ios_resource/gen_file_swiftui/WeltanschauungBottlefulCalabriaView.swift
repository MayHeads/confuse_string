...
struct WeltanschauungBottlefulCalabriaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WeltanschauungBottlefulCalabria")
    }
...
// Preview provider
struct WeltanschauungBottlefulCalabriaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WeltanschauungBottlefulCalabriaView()
        }
    }
}
