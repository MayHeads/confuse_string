...
struct StarchGenussesamumYogurtView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("StarchGenussesamumYogurt")
    }
...
// Preview provider
struct StarchGenussesamumYogurtView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            StarchGenussesamumYogurtView()
        }
    }
}
