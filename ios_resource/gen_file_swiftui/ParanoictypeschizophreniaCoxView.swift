...
struct ParanoictypeschizophreniaCoxView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ParanoictypeschizophreniaCox")
    }
...
// Preview provider
struct ParanoictypeschizophreniaCoxView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ParanoictypeschizophreniaCoxView()
        }
    }
}
