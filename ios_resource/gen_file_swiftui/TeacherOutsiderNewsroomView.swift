...
struct TeacherOutsiderNewsroomView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TeacherOutsiderNewsroom")
    }
...
// Preview provider
struct TeacherOutsiderNewsroomView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TeacherOutsiderNewsroomView()
        }
    }
}
