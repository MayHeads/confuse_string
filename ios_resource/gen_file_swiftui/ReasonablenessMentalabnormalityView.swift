...
public struct ReasonablenessMentalabnormalityView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ReasonablenessMentalabnormality")
    }
...
// Preview provider
public struct ReasonablenessMentalabnormalityView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ReasonablenessMentalabnormalityView()
        }
    }
}
