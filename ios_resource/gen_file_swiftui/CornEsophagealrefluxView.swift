...
struct CornEsophagealrefluxView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CornEsophagealreflux")
    }
...
// Preview provider
struct CornEsophagealrefluxView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CornEsophagealrefluxView()
        }
    }
}
