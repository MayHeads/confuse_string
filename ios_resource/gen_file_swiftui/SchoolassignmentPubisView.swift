...
struct SchoolassignmentPubisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SchoolassignmentPubis")
    }
...
// Preview provider
struct SchoolassignmentPubisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SchoolassignmentPubisView()
        }
    }
}
