...
public struct MooringmastDigitalsubscriberlineView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MooringmastDigitalsubscriberline")
    }
...
// Preview provider
public struct MooringmastDigitalsubscriberlineView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MooringmastDigitalsubscriberlineView()
        }
    }
}
