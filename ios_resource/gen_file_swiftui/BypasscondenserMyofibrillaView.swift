...
public struct BypasscondenserMyofibrillaView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("neutralizeMandateMarshal")
                        .resizable()
        ...
        .navigationTitle("BypasscondenserMyofibrilla")
    }
...
// Preview provider
public struct BypasscondenserMyofibrillaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BypasscondenserMyofibrillaView()
        }
    }
}
