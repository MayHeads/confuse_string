...
public struct RangeSailplaningView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("RangeSailplaning")
    }
...
// Preview provider
public struct RangeSailplaningView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            RangeSailplaningView()
        }
    }
}
