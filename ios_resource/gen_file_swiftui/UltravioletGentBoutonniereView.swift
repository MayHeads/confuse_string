...
struct UltravioletGentBoutonniereView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UltravioletGentBoutonniere")
    }
...
// Preview provider
struct UltravioletGentBoutonniereView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UltravioletGentBoutonniereView()
        }
    }
}
