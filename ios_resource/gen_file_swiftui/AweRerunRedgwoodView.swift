...
public struct AweRerunRedgwoodView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AweRerunRedgwood")
    }
...
// Preview provider
public struct AweRerunRedgwoodView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AweRerunRedgwoodView()
        }
    }
}
