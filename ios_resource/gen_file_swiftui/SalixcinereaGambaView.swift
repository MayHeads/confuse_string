...
public struct SalixcinereaGambaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SalixcinereaGamba")
    }
...
// Preview provider
public struct SalixcinereaGambaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SalixcinereaGambaView()
        }
    }
}
