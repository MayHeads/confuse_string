...
public struct DortmundNotropisatherinoidesCtView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("DortmundNotropisatherinoidesCt")
    }
...
// Preview provider
public struct DortmundNotropisatherinoidesCtView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            DortmundNotropisatherinoidesCtView()
        }
    }
}
