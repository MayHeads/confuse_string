...
public struct AngwantiboMackintoshGeneralView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AngwantiboMackintoshGeneral")
    }
...
// Preview provider
public struct AngwantiboMackintoshGeneralView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AngwantiboMackintoshGeneralView()
        }
    }
}
