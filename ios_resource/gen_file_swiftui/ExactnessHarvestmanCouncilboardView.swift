...
struct ExactnessHarvestmanCouncilboardView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ExactnessHarvestmanCouncilboard")
    }
...
// Preview provider
struct ExactnessHarvestmanCouncilboardView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ExactnessHarvestmanCouncilboardView()
        }
    }
}
