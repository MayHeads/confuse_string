...
public struct FatiguecrackMultivalenceView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FatiguecrackMultivalence")
    }
...
// Preview provider
public struct FatiguecrackMultivalenceView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FatiguecrackMultivalenceView()
        }
    }
}
