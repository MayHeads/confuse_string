...
struct TactualsensationMarkuplanguageView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TactualsensationMarkuplanguage")
    }
...
// Preview provider
struct TactualsensationMarkuplanguageView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TactualsensationMarkuplanguageView()
        }
    }
}
