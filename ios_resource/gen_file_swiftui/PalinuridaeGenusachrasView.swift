...
public struct PalinuridaeGenusachrasView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("PalinuridaeGenusachras")
    }
...
// Preview provider
public struct PalinuridaeGenusachrasView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            PalinuridaeGenusachrasView()
        }
    }
}
