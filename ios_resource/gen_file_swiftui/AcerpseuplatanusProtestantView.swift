...
public struct AcerpseuplatanusProtestantView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AcerpseuplatanusProtestant")
    }
...
// Preview provider
public struct AcerpseuplatanusProtestantView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AcerpseuplatanusProtestantView()
        }
    }
}
