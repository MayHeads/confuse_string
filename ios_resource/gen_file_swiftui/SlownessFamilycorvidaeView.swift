...
public struct SlownessFamilycorvidaeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SlownessFamilycorvidae")
    }
...
// Preview provider
public struct SlownessFamilycorvidaeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SlownessFamilycorvidaeView()
        }
    }
}
