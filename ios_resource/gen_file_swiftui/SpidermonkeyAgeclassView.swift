...
struct SpidermonkeyAgeclassView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SpidermonkeyAgeclass")
    }
...
// Preview provider
struct SpidermonkeyAgeclassView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SpidermonkeyAgeclassView()
        }
    }
}
