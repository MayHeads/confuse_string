...
public struct FowlrunTeleosteiView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FowlrunTeleostei")
    }
...
// Preview provider
public struct FowlrunTeleosteiView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FowlrunTeleosteiView()
        }
    }
}
