...
public struct DangerBanditryCakeView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("possessRevereGastrinDryden")
                        .resizable()
        ...
        .navigationTitle("DangerBanditryCake")
    }
...
// Preview provider
public struct DangerBanditryCakeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            DangerBanditryCakeView()
        }
    }
}
