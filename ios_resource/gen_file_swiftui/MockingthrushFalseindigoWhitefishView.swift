...
struct MockingthrushFalseindigoWhitefishView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MockingthrushFalseindigoWhitefish")
    }
...
// Preview provider
struct MockingthrushFalseindigoWhitefishView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MockingthrushFalseindigoWhitefishView()
        }
    }
}
