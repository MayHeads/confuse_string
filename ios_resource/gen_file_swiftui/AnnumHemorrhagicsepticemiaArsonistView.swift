...
struct AnnumHemorrhagicsepticemiaArsonistView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AnnumHemorrhagicsepticemiaArsonist")
    }
...
// Preview provider
struct AnnumHemorrhagicsepticemiaArsonistView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AnnumHemorrhagicsepticemiaArsonistView()
        }
    }
}
