...
struct BlacktopBrandynoseNoseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BlacktopBrandynoseNose")
    }
...
// Preview provider
struct BlacktopBrandynoseNoseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlacktopBrandynoseNoseView()
        }
    }
}
