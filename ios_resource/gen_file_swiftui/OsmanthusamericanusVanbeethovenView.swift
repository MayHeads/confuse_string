...
struct OsmanthusamericanusVanbeethovenView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OsmanthusamericanusVanbeethoven")
    }
...
// Preview provider
struct OsmanthusamericanusVanbeethovenView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OsmanthusamericanusVanbeethovenView()
        }
    }
}
