...
struct BlastogenesisGospeltruthMaximgunView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    ...
                    Image("kotowWreckQuercusstellata")
                        .resizable()
                        .frame(height: 100)
                        .opacity(0.5)
                }
        ...
        .navigationTitle("BlastogenesisGospeltruthMaximgun")
    }
...
// Preview provider
struct BlastogenesisGospeltruthMaximgunView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlastogenesisGospeltruthMaximgunView()
        }
    }
}
