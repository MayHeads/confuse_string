...
public struct NeboSelfinductanceView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("beachMiddleearLaterality")
                        .resizable()
        ...
        .navigationTitle("NeboSelfinductance")
    }
...
// Preview provider
public struct NeboSelfinductanceView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            NeboSelfinductanceView()
        }
    }
}
