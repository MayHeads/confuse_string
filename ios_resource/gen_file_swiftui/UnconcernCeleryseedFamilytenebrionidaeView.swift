...
public struct UnconcernCeleryseedFamilytenebrionidaeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("UnconcernCeleryseedFamilytenebrionidae")
    }
...
// Preview provider
public struct UnconcernCeleryseedFamilytenebrionidaeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            UnconcernCeleryseedFamilytenebrionidaeView()
        }
    }
}
