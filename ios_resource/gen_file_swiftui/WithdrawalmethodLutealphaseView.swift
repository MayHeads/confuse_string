...
struct WithdrawalmethodLutealphaseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WithdrawalmethodLutealphase")
    }
...
// Preview provider
struct WithdrawalmethodLutealphaseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WithdrawalmethodLutealphaseView()
        }
    }
}
