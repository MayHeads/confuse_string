...
struct FamilyxantusiidaeAethusaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FamilyxantusiidaeAethusa")
    }
...
// Preview provider
struct FamilyxantusiidaeAethusaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FamilyxantusiidaeAethusaView()
        }
    }
}
