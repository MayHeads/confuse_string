...
struct DruguserTaysachsdiseaseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DruguserTaysachsdisease")
    }
...
// Preview provider
struct DruguserTaysachsdiseaseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DruguserTaysachsdiseaseView()
        }
    }
}
