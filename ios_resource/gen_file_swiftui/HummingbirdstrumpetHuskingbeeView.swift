...
struct HummingbirdstrumpetHuskingbeeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HummingbirdstrumpetHuskingbee")
    }
...
// Preview provider
struct HummingbirdstrumpetHuskingbeeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HummingbirdstrumpetHuskingbeeView()
        }
    }
}
