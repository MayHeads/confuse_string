...
struct JohnmiltoncagejrBooktokenView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("JohnmiltoncagejrBooktoken")
    }
...
// Preview provider
struct JohnmiltoncagejrBooktokenView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            JohnmiltoncagejrBooktokenView()
        }
    }
}
