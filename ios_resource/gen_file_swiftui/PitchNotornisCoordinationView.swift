...
struct PitchNotornisCoordinationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PitchNotornisCoordination")
    }
...
// Preview provider
struct PitchNotornisCoordinationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PitchNotornisCoordinationView()
        }
    }
}
