...
struct PaulnewmanLikeningShiftkeyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PaulnewmanLikeningShiftkey")
    }
...
// Preview provider
struct PaulnewmanLikeningShiftkeyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PaulnewmanLikeningShiftkeyView()
        }
    }
}
