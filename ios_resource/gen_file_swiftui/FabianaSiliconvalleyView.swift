...
public struct FabianaSiliconvalleyView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FabianaSiliconvalley")
    }
...
// Preview provider
public struct FabianaSiliconvalleyView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FabianaSiliconvalleyView()
        }
    }
}
