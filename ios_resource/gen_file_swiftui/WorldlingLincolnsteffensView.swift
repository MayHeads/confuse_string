...
struct WorldlingLincolnsteffensView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WorldlingLincolnsteffens")
    }
...
// Preview provider
struct WorldlingLincolnsteffensView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WorldlingLincolnsteffensView()
        }
    }
}
