...
struct FallbloominghydrangeaDisengagementView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FallbloominghydrangeaDisengagement")
    }
...
// Preview provider
struct FallbloominghydrangeaDisengagementView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FallbloominghydrangeaDisengagementView()
        }
    }
}
