...
struct GeoffreyofmonmouthRhapsodySidejudgeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("GeoffreyofmonmouthRhapsodySidejudge")
    }
...
// Preview provider
struct GeoffreyofmonmouthRhapsodySidejudgeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            GeoffreyofmonmouthRhapsodySidejudgeView()
        }
    }
}
