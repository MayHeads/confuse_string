...
struct DukeuniversityVibriofetusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DukeuniversityVibriofetus")
    }
...
// Preview provider
struct DukeuniversityVibriofetusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            DukeuniversityVibriofetusView()
        }
    }
}
