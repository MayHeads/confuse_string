...
struct MarkweedMarumikumquatRijsttaffelView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MarkweedMarumikumquatRijsttaffel")
    }
...
// Preview provider
struct MarkweedMarumikumquatRijsttaffelView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MarkweedMarumikumquatRijsttaffelView()
        }
    }
}
