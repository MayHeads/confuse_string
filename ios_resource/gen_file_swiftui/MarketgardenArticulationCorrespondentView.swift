...
public struct MarketgardenArticulationCorrespondentView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MarketgardenArticulationCorrespondent")
    }
...
// Preview provider
public struct MarketgardenArticulationCorrespondentView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MarketgardenArticulationCorrespondentView()
        }
    }
}
