...
struct BattalionHoldingdeviceJennetView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BattalionHoldingdeviceJennet")
    }
...
// Preview provider
struct BattalionHoldingdeviceJennetView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BattalionHoldingdeviceJennetView()
        }
    }
}
