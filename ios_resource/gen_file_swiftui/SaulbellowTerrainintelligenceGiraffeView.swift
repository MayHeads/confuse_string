...
struct SaulbellowTerrainintelligenceGiraffeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SaulbellowTerrainintelligenceGiraffe")
    }
...
// Preview provider
struct SaulbellowTerrainintelligenceGiraffeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SaulbellowTerrainintelligenceGiraffeView()
        }
    }
}
