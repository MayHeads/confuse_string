...
struct FirefighterGlochidNibbleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FirefighterGlochidNibble")
    }
...
// Preview provider
struct FirefighterGlochidNibbleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FirefighterGlochidNibbleView()
        }
    }
}
