...
struct StenographyOmegacentauriView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("StenographyOmegacentauri")
    }
...
// Preview provider
struct StenographyOmegacentauriView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            StenographyOmegacentauriView()
        }
    }
}
