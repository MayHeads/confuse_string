...
struct VigilantismAeschylusWordsView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("VigilantismAeschylusWords")
    }
...
// Preview provider
struct VigilantismAeschylusWordsView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            VigilantismAeschylusWordsView()
        }
    }
}
