...
struct EtiolationUnitedarabemiratesDactylopiusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EtiolationUnitedarabemiratesDactylopius")
    }
...
// Preview provider
struct EtiolationUnitedarabemiratesDactylopiusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EtiolationUnitedarabemiratesDactylopiusView()
        }
    }
}
