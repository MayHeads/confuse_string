...
public struct WorddeafnessEagleActofterrorismView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("WorddeafnessEagleActofterrorism")
    }
...
// Preview provider
public struct WorddeafnessEagleActofterrorismView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            WorddeafnessEagleActofterrorismView()
        }
    }
}
