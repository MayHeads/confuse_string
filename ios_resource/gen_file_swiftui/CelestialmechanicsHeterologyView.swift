...
struct CelestialmechanicsHeterologyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CelestialmechanicsHeterology")
    }
...
// Preview provider
struct CelestialmechanicsHeterologyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CelestialmechanicsHeterologyView()
        }
    }
}
