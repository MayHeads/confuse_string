...
public struct VenanasofrontalisPixchestView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("VenanasofrontalisPixchest")
    }
...
// Preview provider
public struct VenanasofrontalisPixchestView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            VenanasofrontalisPixchestView()
        }
    }
}
