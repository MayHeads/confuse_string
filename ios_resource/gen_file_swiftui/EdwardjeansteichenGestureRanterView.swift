...
struct EdwardjeansteichenGestureRanterView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EdwardjeansteichenGestureRanter")
    }
...
// Preview provider
struct EdwardjeansteichenGestureRanterView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EdwardjeansteichenGestureRanterView()
        }
    }
}
