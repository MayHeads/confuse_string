...
struct TaxodiumdistichumMurderindictmentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TaxodiumdistichumMurderindictment")
    }
...
// Preview provider
struct TaxodiumdistichumMurderindictmentView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TaxodiumdistichumMurderindictmentView()
        }
    }
}
