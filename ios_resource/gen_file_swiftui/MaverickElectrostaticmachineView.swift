...
struct MaverickElectrostaticmachineView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MaverickElectrostaticmachine")
    }
...
// Preview provider
struct MaverickElectrostaticmachineView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MaverickElectrostaticmachineView()
        }
    }
}
