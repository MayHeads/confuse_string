...
struct BlacktaileddeerRepublicofhungaryFijisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BlacktaileddeerRepublicofhungaryFijis")
    }
...
// Preview provider
struct BlacktaileddeerRepublicofhungaryFijisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BlacktaileddeerRepublicofhungaryFijisView()
        }
    }
}
