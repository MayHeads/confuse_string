...
struct ContadinoSphyrnazygaenaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ContadinoSphyrnazygaena")
    }
...
// Preview provider
struct ContadinoSphyrnazygaenaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ContadinoSphyrnazygaenaView()
        }
    }
}
