...
struct ChouenlaiRingtailPostView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ChouenlaiRingtailPost")
    }
...
// Preview provider
struct ChouenlaiRingtailPostView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ChouenlaiRingtailPostView()
        }
    }
}
