...
public struct FurbelowWesternragweedView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("FurbelowWesternragweed")
    }
...
// Preview provider
public struct FurbelowWesternragweedView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            FurbelowWesternragweedView()
        }
    }
}
