...
struct WastewaterIndiansennaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WastewaterIndiansenna")
    }
...
// Preview provider
struct WastewaterIndiansennaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WastewaterIndiansennaView()
        }
    }
}
