...
public struct NicotineSomesthesiaView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    ...
                    Image("boatraceRecaptureGenusfulicaGallantry")
                        .resizable()
                        .frame(height: 100)
                        .opacity(0.5)
                }
        ...
        .navigationTitle("NicotineSomesthesia")
    }
...
// Preview provider
public struct NicotineSomesthesiaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            NicotineSomesthesiaView()
        }
    }
}
