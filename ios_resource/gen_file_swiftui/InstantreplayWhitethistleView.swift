...
struct InstantreplayWhitethistleView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("InstantreplayWhitethistle")
    }
...
// Preview provider
struct InstantreplayWhitethistleView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            InstantreplayWhitethistleView()
        }
    }
}
