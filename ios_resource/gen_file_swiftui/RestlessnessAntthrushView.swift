...
public struct RestlessnessAntthrushView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("RestlessnessAntthrush")
    }
...
// Preview provider
public struct RestlessnessAntthrushView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            RestlessnessAntthrushView()
        }
    }
}
