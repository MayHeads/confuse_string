...
public struct ChamaeleonWitCupressussempervirensView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ChamaeleonWitCupressussempervirens")
    }
...
// Preview provider
public struct ChamaeleonWitCupressussempervirensView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ChamaeleonWitCupressussempervirensView()
        }
    }
}
