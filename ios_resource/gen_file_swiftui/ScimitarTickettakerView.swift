...
public struct ScimitarTickettakerView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ScimitarTickettaker")
    }
...
// Preview provider
public struct ScimitarTickettakerView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ScimitarTickettakerView()
        }
    }
}
