...
struct ThymosinImmobilizationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ThymosinImmobilization")
    }
...
// Preview provider
struct ThymosinImmobilizationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ThymosinImmobilizationView()
        }
    }
}
