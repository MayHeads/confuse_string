...
public struct RegularpaymentMarxView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("RegularpaymentMarx")
    }
...
// Preview provider
public struct RegularpaymentMarxView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            RegularpaymentMarxView()
        }
    }
}
