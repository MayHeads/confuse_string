...
struct TribologyCoppersmithView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TribologyCoppersmith")
    }
...
// Preview provider
struct TribologyCoppersmithView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TribologyCoppersmithView()
        }
    }
}
