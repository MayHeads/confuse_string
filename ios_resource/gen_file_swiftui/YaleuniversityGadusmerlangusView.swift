...
struct YaleuniversityGadusmerlangusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("YaleuniversityGadusmerlangus")
    }
...
// Preview provider
struct YaleuniversityGadusmerlangusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            YaleuniversityGadusmerlangusView()
        }
    }
}
