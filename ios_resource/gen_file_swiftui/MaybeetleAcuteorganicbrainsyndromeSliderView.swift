...
struct MaybeetleAcuteorganicbrainsyndromeSliderView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MaybeetleAcuteorganicbrainsyndromeSlider")
    }
...
// Preview provider
struct MaybeetleAcuteorganicbrainsyndromeSliderView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MaybeetleAcuteorganicbrainsyndromeSliderView()
        }
    }
}
