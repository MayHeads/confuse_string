...
public struct OilcolourMarblingCausaView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("OilcolourMarblingCausa")
    }
...
// Preview provider
public struct OilcolourMarblingCausaView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            OilcolourMarblingCausaView()
        }
    }
}
