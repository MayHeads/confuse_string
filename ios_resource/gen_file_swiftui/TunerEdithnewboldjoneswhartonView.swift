...
public struct TunerEdithnewboldjoneswhartonView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("TunerEdithnewboldjoneswharton")
    }
...
// Preview provider
public struct TunerEdithnewboldjoneswhartonView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            TunerEdithnewboldjoneswhartonView()
        }
    }
}
