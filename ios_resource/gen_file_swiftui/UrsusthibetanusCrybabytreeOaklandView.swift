...
struct UrsusthibetanusCrybabytreeOaklandView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UrsusthibetanusCrybabytreeOakland")
    }
...
// Preview provider
struct UrsusthibetanusCrybabytreeOaklandView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UrsusthibetanusCrybabytreeOaklandView()
        }
    }
}
