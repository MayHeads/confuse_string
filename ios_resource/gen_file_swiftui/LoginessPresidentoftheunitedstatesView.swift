...
struct LoginessPresidentoftheunitedstatesView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LoginessPresidentoftheunitedstates")
    }
...
// Preview provider
struct LoginessPresidentoftheunitedstatesView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LoginessPresidentoftheunitedstatesView()
        }
    }
}
