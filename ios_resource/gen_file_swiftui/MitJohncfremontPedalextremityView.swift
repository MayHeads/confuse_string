...
public struct MitJohncfremontPedalextremityView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MitJohncfremontPedalextremity")
    }
...
// Preview provider
public struct MitJohncfremontPedalextremityView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MitJohncfremontPedalextremityView()
        }
    }
}
