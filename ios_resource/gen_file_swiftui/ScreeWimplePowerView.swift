...
public struct ScreeWimplePowerView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ScreeWimplePower")
    }
...
// Preview provider
public struct ScreeWimplePowerView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ScreeWimplePowerView()
        }
    }
}
