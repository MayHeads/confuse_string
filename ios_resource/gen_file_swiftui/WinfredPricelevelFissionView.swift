...
struct WinfredPricelevelFissionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("WinfredPricelevelFission")
    }
...
// Preview provider
struct WinfredPricelevelFissionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            WinfredPricelevelFissionView()
        }
    }
}
