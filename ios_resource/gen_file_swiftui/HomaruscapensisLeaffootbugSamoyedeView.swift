...
public struct HomaruscapensisLeaffootbugSamoyedeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("HomaruscapensisLeaffootbugSamoyede")
    }
...
// Preview provider
public struct HomaruscapensisLeaffootbugSamoyedeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            HomaruscapensisLeaffootbugSamoyedeView()
        }
    }
}
