...
public struct AutotrophEfficiencyAcView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AutotrophEfficiencyAc")
    }
...
// Preview provider
public struct AutotrophEfficiencyAcView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AutotrophEfficiencyAcView()
        }
    }
}
