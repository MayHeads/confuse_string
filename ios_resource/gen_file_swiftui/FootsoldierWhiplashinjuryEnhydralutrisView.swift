...
struct FootsoldierWhiplashinjuryEnhydralutrisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FootsoldierWhiplashinjuryEnhydralutris")
    }
...
// Preview provider
struct FootsoldierWhiplashinjuryEnhydralutrisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FootsoldierWhiplashinjuryEnhydralutrisView()
        }
    }
}
