...
struct EmphasisPancreaticfibrosisAthanasiusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EmphasisPancreaticfibrosisAthanasius")
    }
...
// Preview provider
struct EmphasisPancreaticfibrosisAthanasiusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EmphasisPancreaticfibrosisAthanasiusView()
        }
    }
}
