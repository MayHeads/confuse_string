...
struct ThunderbirdExpressionView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ThunderbirdExpression")
    }
...
// Preview provider
struct ThunderbirdExpressionView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ThunderbirdExpressionView()
        }
    }
}
