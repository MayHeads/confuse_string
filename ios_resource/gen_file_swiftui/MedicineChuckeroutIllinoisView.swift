...
struct MedicineChuckeroutIllinoisView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MedicineChuckeroutIllinois")
    }
...
// Preview provider
struct MedicineChuckeroutIllinoisView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MedicineChuckeroutIllinoisView()
        }
    }
}
