...
public struct ScandinavianlanguageCurabilityFallView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("ScandinavianlanguageCurabilityFall")
    }
...
// Preview provider
public struct ScandinavianlanguageCurabilityFallView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            ScandinavianlanguageCurabilityFallView()
        }
    }
}
