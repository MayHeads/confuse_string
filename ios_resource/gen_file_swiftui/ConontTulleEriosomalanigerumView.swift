...
struct ConontTulleEriosomalanigerumView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ConontTulleEriosomalanigerum")
    }
...
// Preview provider
struct ConontTulleEriosomalanigerumView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ConontTulleEriosomalanigerumView()
        }
    }
}
