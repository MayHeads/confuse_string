...
struct HamiltonMexicanmintTachygraphyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HamiltonMexicanmintTachygraphy")
    }
...
// Preview provider
struct HamiltonMexicanmintTachygraphyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HamiltonMexicanmintTachygraphyView()
        }
    }
}
