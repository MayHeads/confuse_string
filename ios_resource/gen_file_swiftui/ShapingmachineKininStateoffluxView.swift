...
struct ShapingmachineKininStateoffluxView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ShapingmachineKininStateofflux")
    }
...
// Preview provider
struct ShapingmachineKininStateoffluxView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ShapingmachineKininStateoffluxView()
        }
    }
}
