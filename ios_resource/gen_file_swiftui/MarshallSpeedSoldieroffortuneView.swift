...
public struct MarshallSpeedSoldieroffortuneView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("MarshallSpeedSoldieroffortune")
    }
...
// Preview provider
public struct MarshallSpeedSoldieroffortuneView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            MarshallSpeedSoldieroffortuneView()
        }
    }
}
