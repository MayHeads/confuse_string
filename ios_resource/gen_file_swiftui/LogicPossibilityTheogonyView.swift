...
struct LogicPossibilityTheogonyView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("LogicPossibilityTheogony")
    }
...
// Preview provider
struct LogicPossibilityTheogonyView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            LogicPossibilityTheogonyView()
        }
    }
}
