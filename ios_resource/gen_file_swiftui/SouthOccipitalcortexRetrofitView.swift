...
struct SouthOccipitalcortexRetrofitView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SouthOccipitalcortexRetrofit")
    }
...
// Preview provider
struct SouthOccipitalcortexRetrofitView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SouthOccipitalcortexRetrofitView()
        }
    }
}
