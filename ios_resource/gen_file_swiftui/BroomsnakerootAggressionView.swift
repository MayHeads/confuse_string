...
public struct BroomsnakerootAggressionView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("BroomsnakerootAggression")
    }
...
// Preview provider
public struct BroomsnakerootAggressionView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            BroomsnakerootAggressionView()
        }
    }
}
