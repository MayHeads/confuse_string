...
struct TulipgentianCreepingfernView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TulipgentianCreepingfern")
    }
...
// Preview provider
struct TulipgentianCreepingfernView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TulipgentianCreepingfernView()
        }
    }
}
