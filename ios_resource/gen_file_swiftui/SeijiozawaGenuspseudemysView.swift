...
struct SeijiozawaGenuspseudemysView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SeijiozawaGenuspseudemys")
    }
...
// Preview provider
struct SeijiozawaGenuspseudemysView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SeijiozawaGenuspseudemysView()
        }
    }
}
