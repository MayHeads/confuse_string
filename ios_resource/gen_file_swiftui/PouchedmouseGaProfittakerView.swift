...
struct PouchedmouseGaProfittakerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PouchedmouseGaProfittaker")
    }
...
// Preview provider
struct PouchedmouseGaProfittakerView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PouchedmouseGaProfittakerView()
        }
    }
}
