...
struct FluteMandibularjointView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FluteMandibularjoint")
    }
...
// Preview provider
struct FluteMandibularjointView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            FluteMandibularjointView()
        }
    }
}
