...
public struct LactucascariolaPanelView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("LactucascariolaPanel")
    }
...
// Preview provider
public struct LactucascariolaPanelView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            LactucascariolaPanelView()
        }
    }
}
