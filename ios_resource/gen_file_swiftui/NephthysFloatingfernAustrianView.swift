...
public struct NephthysFloatingfernAustrianView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("NephthysFloatingfernAustrian")
    }
...
// Preview provider
public struct NephthysFloatingfernAustrianView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            NephthysFloatingfernAustrianView()
        }
    }
}
