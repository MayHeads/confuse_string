...
struct BuzzardRockrattlesnakeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("BuzzardRockrattlesnake")
    }
...
// Preview provider
struct BuzzardRockrattlesnakeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            BuzzardRockrattlesnakeView()
        }
    }
}
