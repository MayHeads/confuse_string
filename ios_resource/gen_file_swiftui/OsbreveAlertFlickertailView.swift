...
struct OsbreveAlertFlickertailView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("OsbreveAlertFlickertail")
    }
...
// Preview provider
struct OsbreveAlertFlickertailView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            OsbreveAlertFlickertailView()
        }
    }
}
