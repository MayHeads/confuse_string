...
struct MusculusbuccinatorRoadwayView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MusculusbuccinatorRoadway")
    }
...
// Preview provider
struct MusculusbuccinatorRoadwayView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            MusculusbuccinatorRoadwayView()
        }
    }
}
