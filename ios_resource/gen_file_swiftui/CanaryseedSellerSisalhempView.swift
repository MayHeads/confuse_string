...
struct CanaryseedSellerSisalhempView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CanaryseedSellerSisalhemp")
    }
...
// Preview provider
struct CanaryseedSellerSisalhempView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CanaryseedSellerSisalhempView()
        }
    }
}
