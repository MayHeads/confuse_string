...
struct HexadecanoicacidRicegrassLeptoptilusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HexadecanoicacidRicegrassLeptoptilus")
    }
...
// Preview provider
struct HexadecanoicacidRicegrassLeptoptilusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HexadecanoicacidRicegrassLeptoptilusView()
        }
    }
}
