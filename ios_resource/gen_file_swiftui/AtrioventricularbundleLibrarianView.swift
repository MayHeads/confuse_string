...
struct AtrioventricularbundleLibrarianView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AtrioventricularbundleLibrarian")
    }
...
// Preview provider
struct AtrioventricularbundleLibrarianView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AtrioventricularbundleLibrarianView()
        }
    }
}
