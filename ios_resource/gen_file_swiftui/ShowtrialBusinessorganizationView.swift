...
struct ShowtrialBusinessorganizationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ShowtrialBusinessorganization")
    }
...
// Preview provider
struct ShowtrialBusinessorganizationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ShowtrialBusinessorganizationView()
        }
    }
}
