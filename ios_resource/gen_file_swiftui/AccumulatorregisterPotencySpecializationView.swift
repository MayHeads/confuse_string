...
public struct AccumulatorregisterPotencySpecializationView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("AccumulatorregisterPotencySpecialization")
    }
...
// Preview provider
public struct AccumulatorregisterPotencySpecializationView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            AccumulatorregisterPotencySpecializationView()
        }
    }
}
