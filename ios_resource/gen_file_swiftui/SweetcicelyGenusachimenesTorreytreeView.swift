...
public struct SweetcicelyGenusachimenesTorreytreeView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("SweetcicelyGenusachimenesTorreytree")
    }
...
// Preview provider
public struct SweetcicelyGenusachimenesTorreytreeView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            SweetcicelyGenusachimenesTorreytreeView()
        }
    }
}
