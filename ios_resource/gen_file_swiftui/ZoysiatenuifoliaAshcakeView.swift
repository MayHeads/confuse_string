...
struct ZoysiatenuifoliaAshcakeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ZoysiatenuifoliaAshcake")
    }
...
// Preview provider
struct ZoysiatenuifoliaAshcakeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ZoysiatenuifoliaAshcakeView()
        }
    }
}
