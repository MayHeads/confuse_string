...
struct PerturbationArsenalTilletiaceaeView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PerturbationArsenalTilletiaceae")
    }
...
// Preview provider
struct PerturbationArsenalTilletiaceaeView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PerturbationArsenalTilletiaceaeView()
        }
    }
}
