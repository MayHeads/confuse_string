...
struct UraniumFondaJailhouseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("UraniumFondaJailhouse")
    }
...
// Preview provider
struct UraniumFondaJailhouseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            UraniumFondaJailhouseView()
        }
    }
}
