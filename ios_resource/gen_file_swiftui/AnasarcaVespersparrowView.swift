...
struct AnasarcaVespersparrowView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("AnasarcaVespersparrow")
    }
...
// Preview provider
struct AnasarcaVespersparrowView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            AnasarcaVespersparrowView()
        }
    }
}
