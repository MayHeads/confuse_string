...
struct HemerobiidaeChangeabilityView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HemerobiidaeChangeability")
    }
...
// Preview provider
struct HemerobiidaeChangeabilityView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HemerobiidaeChangeabilityView()
        }
    }
}
