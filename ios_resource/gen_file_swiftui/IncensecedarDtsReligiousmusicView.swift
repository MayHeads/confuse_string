...
struct IncensecedarDtsReligiousmusicView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("IncensecedarDtsReligiousmusic")
    }
...
// Preview provider
struct IncensecedarDtsReligiousmusicView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            IncensecedarDtsReligiousmusicView()
        }
    }
}
