...
struct TomthumbTractarianIndulgenceView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("TomthumbTractarianIndulgence")
    }
...
// Preview provider
struct TomthumbTractarianIndulgenceView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            TomthumbTractarianIndulgenceView()
        }
    }
}
