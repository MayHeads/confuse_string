...
struct HireSimplificationArtisticmovementView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HireSimplificationArtisticmovement")
    }
...
// Preview provider
struct HireSimplificationArtisticmovementView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HireSimplificationArtisticmovementView()
        }
    }
}
