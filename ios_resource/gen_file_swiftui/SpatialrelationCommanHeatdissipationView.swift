...
struct SpatialrelationCommanHeatdissipationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SpatialrelationCommanHeatdissipation")
    }
...
// Preview provider
struct SpatialrelationCommanHeatdissipationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SpatialrelationCommanHeatdissipationView()
        }
    }
}
