...
struct VolumetricanalysisInvestigationView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("VolumetricanalysisInvestigation")
    }
...
// Preview provider
struct VolumetricanalysisInvestigationView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            VolumetricanalysisInvestigationView()
        }
    }
}
