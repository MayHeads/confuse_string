...
struct SubfamilyuvulariaceaeHazardAmphipodView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("SubfamilyuvulariaceaeHazardAmphipod")
    }
...
// Preview provider
struct SubfamilyuvulariaceaeHazardAmphipodView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            SubfamilyuvulariaceaeHazardAmphipodView()
        }
    }
}
