...
struct CourtofjusticeSeabiscuitView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CourtofjusticeSeabiscuit")
    }
...
// Preview provider
struct CourtofjusticeSeabiscuitView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            CourtofjusticeSeabiscuitView()
        }
    }
}
