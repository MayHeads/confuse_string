...
struct ChichewaGenuseucaryaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ChichewaGenuseucarya")
    }
...
// Preview provider
struct ChichewaGenuseucaryaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ChichewaGenuseucaryaView()
        }
    }
}
