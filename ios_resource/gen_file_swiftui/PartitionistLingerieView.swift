...
public struct PartitionistLingerieView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("PartitionistLingerie")
    }
...
// Preview provider
public struct PartitionistLingerieView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            PartitionistLingerieView()
        }
    }
}
