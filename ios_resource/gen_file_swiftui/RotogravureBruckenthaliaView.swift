...
struct RotogravureBruckenthaliaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("RotogravureBruckenthalia")
    }
...
// Preview provider
struct RotogravureBruckenthaliaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RotogravureBruckenthaliaView()
        }
    }
}
