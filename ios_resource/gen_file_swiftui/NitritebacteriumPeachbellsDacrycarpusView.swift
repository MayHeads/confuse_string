...
struct NitritebacteriumPeachbellsDacrycarpusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("NitritebacteriumPeachbellsDacrycarpus")
    }
...
// Preview provider
struct NitritebacteriumPeachbellsDacrycarpusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NitritebacteriumPeachbellsDacrycarpusView()
        }
    }
}
