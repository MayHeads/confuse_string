...
public struct EpenthesisInnerearWhiteView: View {
    ...
    public var body: some View {
        ...
        .navigationTitle("EpenthesisInnerearWhite")
    }
...
// Preview provider
public struct EpenthesisInnerearWhiteView_Previews: PreviewProvider {
    public static var previews: some View {
        NavigationView {
            EpenthesisInnerearWhiteView()
        }
    }
}
