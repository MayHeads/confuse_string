...
struct RheumaticMetadataOffenseView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("RheumaticMetadataOffense")
    }
...
// Preview provider
struct RheumaticMetadataOffenseView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RheumaticMetadataOffenseView()
        }
    }
}
