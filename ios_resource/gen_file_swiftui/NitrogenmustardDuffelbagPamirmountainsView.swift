...
struct NitrogenmustardDuffelbagPamirmountainsView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                VStack(spacing: 20) {
                    Image("stillhuntQuestMuhammadali")
                        .resizable()
        ...
        .navigationTitle("NitrogenmustardDuffelbagPamirmountains")
    }
...
// Preview provider
struct NitrogenmustardDuffelbagPamirmountainsView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            NitrogenmustardDuffelbagPamirmountainsView()
        }
    }
}
