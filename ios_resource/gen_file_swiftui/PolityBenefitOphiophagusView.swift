...
struct PolityBenefitOphiophagusView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("PolityBenefitOphiophagus")
    }
...
// Preview provider
struct PolityBenefitOphiophagusView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            PolityBenefitOphiophagusView()
        }
    }
}
