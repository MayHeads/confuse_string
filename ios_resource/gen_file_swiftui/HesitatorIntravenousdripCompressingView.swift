...
struct HesitatorIntravenousdripCompressingView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("HesitatorIntravenousdripCompressing")
    }
...
// Preview provider
struct HesitatorIntravenousdripCompressingView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HesitatorIntravenousdripCompressingView()
        }
    }
}
