...
struct ElizabethcadystantonLingvokosmopolitaView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("ElizabethcadystantonLingvokosmopolita")
    }
...
// Preview provider
struct ElizabethcadystantonLingvokosmopolitaView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            ElizabethcadystantonLingvokosmopolitaView()
        }
    }
}
